...
class InvScannerMlpController extends Controller
{
    ...
    public function create()
    {
        ...
        $maxId = InvScanner::where('site', 'MLP')->orderBy('max_id', 'desc')->first();
        ...
        $uniqueString = 'PPAMLPSCN' . str_pad(($maxId % 10000) + 1, 3, '0', STR_PAD_LEFT);
        ...
        return Inertia::render('Inventory/SiteMlp/Scanner/ScannerCreate', ['scanner_code' => $uniqueString, 'department' => $department]);
    }
    ...
    public function edit($id)
    {
        ...
        return Inertia::render('Inventory/SiteMlp/Scanner/ScannerEdit', ['scanner' => $scanner, 'department' => $department, 'department_select' => $department_select]);
    }
