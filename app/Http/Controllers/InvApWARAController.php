...
class InvApWARAController extends Controller
{
    ...
    public function create()
    {
        ...
        if (auth()->user()->role == 'ict_developer' || auth()->user()->site == 'WARA') {
            ...
            $uniqueString = 'PPAWARAAP' . str_pad(($maxId % 10000) + 1, 3, '0', STR_PAD_LEFT);
        } else {
            $maxId = '';
        ...
        return Inertia::render('Inventory/SiteWARA/AccessPoint/AccessPointCreate', ['inventoryNumber' => $uniqueString]);
    }
    ...
    public function edit($apId)
    {
        ...
        return Inertia::render('Inventory/SiteWARA/AccessPoint/AccessPointEdit', ['accessPoint' => $accessPoint]);
    }
