...
class InvApWARAController extends Controller
{
    ...
    {
        return Inertia::render('Inventory/SiteWARA/AccessPoint/AccessPointCreate', ['inventory_number' => session('inventory_number') ?? null]);
    }
    ...
    public function generateCode(Request $request)
    {
        ...
        $prefix = $dataCompany === 'PPA' ? 'PPAADWAP' : 'AMMADWAP';
        ...
        // dd($uniqueString);
        return redirect()->route('accessPointWARA.create')->with([
    ...
    public function generateCodeEdit(Request $request)
    {
        ...
        $uniqueString = $prefix . str_pad(($maxId % 10000) + 1, 3, '0', STR_PAD_LEFT);
        // dd($uniqueString);
        return redirect()->route('accessPointWARA.edit', ['apId' => $id])
    ...
    public function store(Request $request)
    {
        ...
        InvAp::create($data);
        return redirect()->route('accessPointWARA.page');
    }
    ...
    public function uploadCsv(Request $request)
    {
        try {
            ...
            // dd($duplicates);
            return Redirect::route('accessPointWARA.page')->with([
    ...
    public function edit($apId)
    {
        ...
        if (str_starts_with($inventoryNumber, 'PPAADWAP')) {
            $company = 'PPA';
        } elseif (str_starts_with($inventoryNumber, 'AMMADWAP')) {
            $company = 'AMM';
        }

        return Inertia::render('Inventory/SiteWARA/AccessPoint/AccessPointEdit', [
    ...
    public function detail($id)
    {
        ...
        return Inertia::render('Inventory/SiteWARA/AccessPoint/AccessPointDetail', [
