...
class AduanDmpController extends Controller
{
    ...
    ")
        ...
        $crew = User::whereIn('role', ['ict_technician', 'ict_group_leader'])->where('site', 'DMP')->pluck('name')->map(function ($name) {
            return ['name' => $name];
        })->toArray();

        return Inertia::render(
            'Inventory/SiteDmp/Aduan/Aduan',
            [
                'aduan' => $aduan,
                'crew' => $crew,
                'open' => $countOpen,
    ...
    {
        $aduanBaru = Aduan::where('site', 'DMP')->orderBy('id', 'desc')->first();
    ...
    public function create()
    {
        ...
        $maxId = Aduan::whereDate('created_at', $currentDate->format('Y-m-d'))->where('site', 'DMP')->orderBy('max_id', 'desc')->first();
        ...
        $crew = User::where('site', 'DMP')->where('ict_group', 'Y')->pluck('name')->map(function ($name) {
            return ['name' => $name];
        })->toArray();

        return Inertia::render('Inventory/SiteDmp/Aduan/AduanCreate', ['ticket' => $uniqueString, 'crew' => $crew, 'categories' => $categories]);
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('aduanDmp.page');
    }
    ...
    public function progress($id)
    {
        ...
        return Inertia::render('Inventory/SiteDmp/Aduan/AduanProgress', [
            'aduan' => $aduan,
            'crew' => $crew,
    ...
    public function edit($id)
    {
        ...
        $crew = User::where('site', 'DMP')->where('ict_group', 'Y')->where('ict_group', 'Y')->pluck('name')->map(function ($name) {
            return ['name' => $name];
        })->toArray();
        return Inertia::render('Inventory/SiteDmp/Aduan/AduanEdit', [
            'aduan' => $aduan,
            'crew' => $crew,
    ...
    public function detail($id)
    {
        ...
        return Inertia::render('Inventory/SiteDmp/Aduan/AduanDetail', [
            'aduan' => $aduan,
        ]);
    }
