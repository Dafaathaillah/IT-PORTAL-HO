...
class InvApSbsController extends Controller
{
    ...
    public function create()
    {
        ...
        if (auth()->user()->role == 'ict_developer' || auth()->user()->site == 'SBS') {
            $maxId = InvAp::where('site', 'SBS')->orderBy('max_id', 'desc')->first();
            ...
            $uniqueString = 'PPASBSAP' . str_pad(($maxId % 10000) + 1, 3, '0', STR_PAD_LEFT);
        } else {
            $maxId = '';
        ...
        return Inertia::render('Inventory/SiteSbs/AccessPoint/AccessPointCreate', ['inventoryNumber' => $uniqueString]);
    }
    ...
    public function edit($apId)
    {
        ...
        return Inertia::render('Inventory/SiteSbs/AccessPoint/AccessPointEdit', ['accessPoint' => $accessPoint]);
    }
