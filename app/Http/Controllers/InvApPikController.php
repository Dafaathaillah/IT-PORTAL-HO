...
class InvApPikController extends Controller
{
    ...
    public function create()
    {
        ...
        if (auth()->user()->role == 'ict_developer' || auth()->user()->site == 'PIK') {
            $maxId = InvAp::where('site', 'PIK')->orderBy('max_id', 'desc')->first();
            ...
            $uniqueString = 'PPAPIKAP' . str_pad(($maxId % 10000) + 1, 3, '0', STR_PAD_LEFT);
        } else {
            $maxId = '';
        ...
        return Inertia::render('Inventory/SitePik/AccessPoint/AccessPointCreate', ['inventoryNumber' => $uniqueString]);
    }
    ...
    public function edit($apId)
    {
        ...
        return Inertia::render('Inventory/SitePik/AccessPoint/AccessPointEdit', ['accessPoint' => $accessPoint]);
    }
