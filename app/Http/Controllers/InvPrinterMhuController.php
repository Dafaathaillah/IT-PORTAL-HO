...
class InvPrinterMhuController extends Controller
{
    ...
    public function create()
    {
        ...
        return Inertia::render('Inventory/SiteMhu/Printer/PrinterCreate', ['inventory_number' => session('inventory_number') ?? null, 'department' => $department]);
    }
    ...
    public function generateCode(Request $request)
    {
        ...
        // dd($uniqueString);
        return redirect()->route('printerMhu.create')->with([
    ...
    public function generateCodeEdit(Request $request)
    {
        ...
        $uniqueString = $prefix . str_pad(($maxId % 10000) + 1, 3, '0', STR_PAD_LEFT);
        // dd($uniqueString);
        return redirect()->route('printerMhu.edit', ['id' => $id])
    ...
    public function edit($printerId)
    {
        ...
        if (str_starts_with($inventoryNumber, 'PPAMHUPRT')) {
            $company = 'PPA';
        } elseif (str_starts_with($inventoryNumber, 'AMMMHUPRT')) {
            $company = 'AMM';
        }
        ...
        return Inertia::render('Inventory/SiteMhu/Printer/PrinterEdit', [
