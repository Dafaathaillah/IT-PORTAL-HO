...
class InvPrinterController extends Controller
{
    ...
    public function create()
    {
        ...
        return Inertia::render('Inventory/Printer/PrinterCreate', ['inventory_number' => session('inventory_number') ?? null, 'department' => $department]);
    }
    ...
    public function generateCode(Request $request)
    {
        ...
        // dd($uniqueString);
        return redirect()->route('printer.create')->with([
    ...
    public function generateCodeEdit(Request $request)
    {
        ...
        $uniqueString = $prefix . str_pad(($maxId % 10000) + 1, 3, '0', STR_PAD_LEFT);
        // dd($uniqueString);
        return redirect()->route('printer.edit', ['id' => $id])
    ...
    public function edit($printerId)
    {
        ...
        if (str_starts_with($inventoryNumber, 'PPAHOPRT')) {
            $company = 'PPA';
        } elseif (str_starts_with($inventoryNumber, 'AMMHOPRT')) {
            $company = 'AMM';
        }
        ...
        return Inertia::render('Inventory/Printer/PrinterEdit', [
            'printer' => $printer, 
