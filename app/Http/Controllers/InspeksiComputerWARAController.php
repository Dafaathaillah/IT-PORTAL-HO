...
class InspeksiComputerWARAController extends Controller
{
    ...
    public function doInspection($id)
    {
        ...
        return Inertia::render('Inspeksi/SiteWARA/Komputer/InspeksiKomputerForm', ['inspeksi' => $dataInspeksi, 'crew' => $crew]);
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('inspeksiKomputerWARA.page');
    }
    ...
    public function detail($id)
    {
        ...
        return Inertia::render('Inspeksi/SiteWARA/Komputer/InspeksiKomputerDetail', [
