...
class InvSwitchSbsController extends Controller
{
    public function index()
    {

        $dataInventory = InvSwitch::where('site', 'SBS')->orderBy('inventory_number', 'desc')->get();
        $site = auth()->user()->site;
        $role = auth()->user()->role;

        return Inertia::render('Inventory/SiteSbs/Switch/Switch', ['switch' => $dataInventory, 'site' => $site, 'role' => $role]);
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('switchSbs.page');
    }
    ...
    public function uploadCsv(Request $request)
    {
        try {
            ...
            // dd($duplicates);
            return Redirect::route('switchSbs.page')->with([
    ...
    public function detail($id)
    {
        ...
        return Inertia::render('Inventory/SiteSbs/Switch/SwitchDetail', [
            'switchs' => $switch,
        ]);
    }
