...
class AduanIptController extends Controller
{
    ...
    {
        $aduanBaru = Aduan::where('site', 'IPT')->orderBy('id', 'desc')->first();
    ...
    public function create()
    {
        ...
        $maxId = Aduan::whereDate('created_at', $currentDate->format('Y-m-d'))->where('site', 'IPT')->orderBy('max_id', 'desc')->first();
        ...
        $crew = User::where('site', 'IPT')->where('ict_group', 'Y')->pluck('name')->map(function ($name) {
            return ['name' => $name];
        })->toArray();

        return Inertia::render('Inventory/SiteIpt/Aduan/AduanCreate', ['ticket' => $uniqueString, 'crew' => $crew, 'categories' => $categories]);
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('aduanIpt.page');
    }
    ...
    public function progress($id)
    {
        ...
        return Inertia::render('Inventory/SiteIpt/Aduan/AduanProgress', [
            'aduan' => $aduan,
            'crew' => $crew,
    ...
    public function edit($id)
    {
        ...
        return Inertia::render('Inventory/SiteIpt/Aduan/AduanEdit', [
            'aduan' => $aduan,
            'crew' => $crew,
    ...
    public function detail($id)
    {
        ...
        return Inertia::render('Inventory/SiteIpt/Aduan/AduanDetail', [
            'aduan' => $aduan,
        ]);
    }
