...
class InspeksiLaptopBibController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $maxId = InspeksiLaptop::where('site', "BIB")->where('year', $year)->max('pica_number');
    ...
    public function edit($id)
    {
        ...
        return Inertia::render('Inspeksi/SiteBib/Laptop/InspeksiLaptopEdit', ['dataInspeksi' => $dataInspeksix, 'pengguna' => $penggunax, 'laptop' => $laptopx, 'pengguna_selected' => $pengguna_selected]);
    }
    ...
    public function approval(Request $request)
    {
        ...
        $site = 'BIB'; // fallback jika site tidak tersedia
    ...
    public function detail($id)
    {
        ...
        return Inertia::render('Inspeksi/SiteBib/Laptop/InspeksiLaptopDetail', [
