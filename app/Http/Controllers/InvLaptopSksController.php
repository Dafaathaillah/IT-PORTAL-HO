...
class InvLaptopSksController extends Controller
{
    public function index()
    {
        $dataInventory = InvLaptop::with('pengguna')->where('site', 'SKS')->get();
        ...
        return Inertia::render('Inventory/SiteSks/Laptop/Laptop', ['laptop' => $dataInventory, 'site' => $site, 'role' => $role, 'department' => $department]);
    }
    ...
    public function store(Request $request)
    {
        ...
        if ($params['roterx'] == 'index') {
            ...
            $maxId = InvLaptop::where('site', 'SKS')->where('dept', $code_dept->code)->orderBy('max_id', 'desc')->first();
            // dd($maxId);
            ...
            return Inertia::render('Inventory/SiteSks/Laptop/LaptopCreate', ['inventoryNumber' => $uniqueString, 'pengguna' => $pengguna, 'dept' => $code_dept->code]);
        } else {
    ...
    public function edit($id)
    {
        ...
        return Inertia::render('Inventory/SiteSks/Laptop/LaptopEdit', [
            'laptop' => $laptop,
            'model' => $model,
            'processor' => $processor,
            'hdd' => $hdd,
    ...
    public function detail($id)
    {
        ...
        return Inertia::render('Inventory/SiteSks/Laptop/LaptopDetail', [
            'laptop' => $laptop,
            'aduan' => $aduan,
            'inspeksi' => $inspeksi,
