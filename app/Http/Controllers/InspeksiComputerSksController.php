...
class InspeksiComputerSksController extends Controller
{
    public function index()
    {
        $inspeksi_computer = InspeksiComputer::with('computer.pengguna')->where('site', 'SKS')->get();
        ...
        return Inertia::render(
            'Inspeksi/SiteSks/Komputer/InspeksiKomputerIndex',
    ...
    public function doInspection($id)
    {
        ...
        return Inertia::render('Inspeksi/SiteSks/Komputer/InspeksiKomputerForm', ['inspeksi' => $dataInspeksi, 'crew' => $crew]);
    }
    ...
    public function store(Request $request)
    {
        ...
        $maxId = InspeksiComputer::where('site', 'SKS')->where('year', $year)->max('pica_number');
        ...
        return redirect()->route('inspeksiKomputerSks.page');
    }
    ...
    public function edit($id)
    {
        ...
        return Inertia::render('Inspeksi/SiteSks/Komputer/InspeksiKomputerFormEdit', ['inspeksi' => $dataInspeksi, 'crew' => $crew, 'crew_select' => $crew_select]);
    }
    ...
    public function detail($id)
    {
        ...
        return Inertia::render('Inspeksi/SiteSks/Komputer/InspeksiKomputerDetail', [
