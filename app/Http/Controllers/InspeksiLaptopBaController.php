...
class InspeksiLaptopBaController extends Controller
{
    public function index(Request $request)
    {
        ...
        $inspeksi_laptop = InspeksiLaptop::with('inventory.pengguna')->where('site', 'BA')->where('year', $yearNow)->get();
    ...
    public function process($id)
    {
        ...
        $penggunax = User::whereIn('role', ['ict_technician', 'ict_group_leader'])->where('site', 'BA')->pluck('name')->map(function ($name) {
            return ['name' => $name];
        })->toArray();
