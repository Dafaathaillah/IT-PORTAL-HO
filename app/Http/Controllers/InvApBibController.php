...
class InvApBibController extends Controller
{
    ...
    public function create()
    {
        ...
        if (auth()->user()->role == 'ict_developer' || auth()->user()->site == 'BIB') {
            $maxId = InvAp::where('site', 'BIB')->orderBy('max_id', 'desc')->first();
        ...
        return Inertia::render('Inventory/SiteBib/AccessPoint/AccessPointCreate', ['inventoryNumber' => $uniqueString]);
    }
    ...
    public function edit($apId)
    {
        ...
        return Inertia::render('Inventory/SiteBib/AccessPoint/AccessPointEdit', ['accessPoint' => $accessPoint]);
    }
