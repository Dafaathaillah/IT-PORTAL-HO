...
class InvCctvIptController extends Controller
{
    ...
    public function create()
    {
        ...
        $maxId = InvCctv::where('site', 'IPT')->orderBy('max_id', 'desc')->first();
        // dd($maxId->cctv_code);
        ...
        $uniqueString = 'PPAIPTCCTV' . str_pad(($maxId % 10000) + 1, 3, '0', STR_PAD_LEFT);
        ...
        return Inertia::render('Inventory/SiteIpt/Cctv/CctvCreate', ['inventoryNumber' => $uniqueString, 'switch' => $switch]);
    }
