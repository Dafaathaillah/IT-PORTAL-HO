...
class InvSwitchMifaController extends Controller
{
    ...
    public function create()
    {
        ...
        $maxId = InvSwitch::where('site', 'MIFA')->orderBy('max_id', 'desc')->first();
        ...
        return Inertia::render('Inventory/SiteMifa/Switch/SwitchCreate', ['inventoryNumber' => $uniqueString]);
    }
    ...
    public function edit($swId)
    {
        ...
        return Inertia::render('Inventory/SiteMifa/Switch/SwitchEdit', ['switch' => $switch]);
    }
