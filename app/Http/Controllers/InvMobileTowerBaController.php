...
class InvMobileTowerBaController extends Controller
{
    ...
    {
        $dataInventory = InvMobileTower::orderBy('inventory_number', 'desc')->where('site', 'BA')->get();
        // dd($dataInventory);
        $site = 'BA';
        $role = auth()->user()->role;
    ...
    public function create()
    {
        ...
        return Inertia::render('Inventory/MobileTower/ba/MobileTowerCreate', ['inventoryNumber' => $site . '-MT-' . $nextNumber]);
    }
