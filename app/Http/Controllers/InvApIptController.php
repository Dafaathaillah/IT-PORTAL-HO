...
class InvApIptController extends Controller
{
    public function index()
    {
        ...
        return Inertia::render('Inventory/SiteIpt/AccessPoint/AccessPoint', ['accessPoint' => $dataInventory, 'site' => $site, 'role' => $role]);
    }

    public function create()
    {
        return Inertia::render('Inventory/SiteIpt/AccessPoint/AccessPointCreate', ['inventory_number' => session('inventory_number') ?? null]);
    }
    ...
    public function generateCode(Request $request)
    {
        ...
        $prefix = $dataCompany === 'PPA' ? 'PPAIPTAP' : 'AMMIPTAP';
        ...
        // dd($uniqueString);
        return redirect()->route('accessPointIpt.create')->with([
    ...
    public function generateCodeEdit(Request $request)
    {
        ...
        $uniqueString = $prefix . str_pad(($maxId % 10000) + 1, 3, '0', STR_PAD_LEFT);
        // dd($uniqueString);
        return redirect()->route('accessPointIpt.edit', ['apId' => $id])
    ...
    public function store(Request $request)
    {
        ...
        InvAp::create($data);
        return redirect()->route('accessPointIpt.page');
    }
    ...
    public function uploadCsv(Request $request)
    {
        try {
            ...
            // dd($duplicates);
            return Redirect::route('accessPointIpt.page')->with([
    ...
    public function edit($apId)
    {
        ...
        if (str_starts_with($inventoryNumber, 'PPAIPTAP')) {
            $company = 'PPA';
        } elseif (str_starts_with($inventoryNumber, 'AMMIPTAP')) {
            $company = 'AMM';
        }

        return Inertia::render('Inventory/SiteIpt/AccessPoint/AccessPointEdit', [
    ...
    public function detail($id)
    {
        ...
        return Inertia::render('Inventory/SiteIpt/AccessPoint/AccessPointDetail', [
