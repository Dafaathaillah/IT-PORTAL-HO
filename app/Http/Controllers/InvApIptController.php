...
class InvApIptController extends Controller
{
    ...
    public function create()
    {
        ...
        if (auth()->user()->role == 'ict_developer' || auth()->user()->site == 'IPT') {
            $maxId = InvAp::where('site', 'IPT')->orderBy('max_id', 'desc')->first();
            ...
            $uniqueString = 'PPAIPTAP' . str_pad(($maxId % 10000) + 1, 3, '0', STR_PAD_LEFT);
        } else {
            $maxId = '';
        ...
        return Inertia::render('Inventory/SiteIpt/AccessPoint/AccessPointCreate', ['inventoryNumber' => $uniqueString]);
    }
    ...
    public function edit($apId)
    {
        ...
        return Inertia::render('Inventory/SiteIpt/AccessPoint/AccessPointEdit', ['accessPoint' => $accessPoint]);
    }
