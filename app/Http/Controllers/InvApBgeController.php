...
class InvApBgeController extends Controller
{
    ...
    public function create()
    {
        ...
        if (auth()->user()->role == 'ict_developer' || auth()->user()->site == 'BGE') {
            $maxId = InvAp::where('site', 'BGE')->orderBy('max_id', 'desc')->first();
            ...
            $uniqueString = 'PPABGEAP' . str_pad(($maxId % 10000) + 1, 3, '0', STR_PAD_LEFT);
        } else {
            $maxId = '';
        ...
        return Inertia::render('Inventory/SiteBge/AccessPoint/AccessPointCreate', ['inventoryNumber' => $uniqueString]);
    }
    ...
    public function edit($apId)
    {
        ...
        return Inertia::render('Inventory/SiteBge/AccessPoint/AccessPointEdit', ['accessPoint' => $accessPoint]);
    }
