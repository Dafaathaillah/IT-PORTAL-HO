...
class InvApBgeController extends Controller
{
    public function index()
    {
        ...
        return Inertia::render('Inventory/SiteBge/AccessPoint/AccessPoint', ['accessPoint' => $dataInventory, 'site' => $site, 'role' => $role]);
    }

    public function create()
    {
        return Inertia::render('Inventory/SiteBge/AccessPoint/AccessPointCreate', ['inventory_number' => session('inventory_number') ?? null]);
    }
    ...
    public function generateCode(Request $request)
    {
        ...
        $prefix = $dataCompany === 'PPA' ? 'PPABGEAP' : 'AMMBGEAP';
        ...
        // dd($uniqueString);
        return redirect()->route('accessPointBge.create')->with([
    ...
    public function generateCodeEdit(Request $request)
    {
        ...
        $uniqueString = $prefix . str_pad(($maxId % 10000) + 1, 3, '0', STR_PAD_LEFT);
        // dd($uniqueString);
        return redirect()->route('accessPointBge.edit', ['apId' => $id])
    ...
    public function edit($apId)
    {
        ...
        if (str_starts_with($inventoryNumber, 'PPABGEAP')) {
            $company = 'PPA';
        } elseif (str_starts_with($inventoryNumber, 'AMMBGEAP')) {
            $company = 'AMM';
        }

        return Inertia::render('Inventory/SiteBge/AccessPoint/AccessPointEdit', [
    ...
    public function detail($id)
    {
        ...
        return Inertia::render('Inventory/SiteBge/AccessPoint/AccessPointDetail', [
