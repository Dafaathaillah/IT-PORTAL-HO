...
class UserAllMifaController extends Controller
{
    public function index()
    {
        $dataPengguna = UserAll::where('site', 'MIFA')->get();
        return Inertia::render('ManagementUser/SiteMifa/ManagementUser', ['pengguna' => $dataPengguna]);
    }
    ...
    public function create()
    {
        ...
        return Inertia::render('ManagementUser/SiteMifa/ManagementUserCreate', ['department' => $department]);
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('penggunaMifa.page');
    }
    ...
    public function edit($apId)
    {
        ...
        return Inertia::render('ManagementUser/SiteMifa/ManagementUserEdit', ['pengguna' => $managementUser, 'department' => $department, 'department_select' => $department_select]);
    }
