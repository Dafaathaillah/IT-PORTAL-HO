...
class InvScannerBaController extends Controller
{
    public function index()
    {
        $dataInventory = InvScanner::where('site', 'BA')->orderBy('scanner_code', 'desc')->get();
        $site = auth()->user()->site;
        $role = auth()->user()->role;
        return Inertia::render('Inventory/SiteBa/Scanner/Scanner', ['scanner' => $dataInventory, 'site' => $site, 'role' => $role]);
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('scannerBa.page');
    }
    ...
    public function detail($id)
    {
        ...
        return Inertia::render('Inventory/SiteBa/Scanner/ScannerDetail', [
            'scanners' => $scanner,
        ]);
    }
