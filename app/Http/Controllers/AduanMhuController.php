...
class AduanMhuController extends Controller
{
    public function index()
    {

        $aduan = Aduan::where('site', 'MHU')
            ->orderByRaw("
        CASE 
    ...
    {
        $aduanBaru = Aduan::where('site', 'MHU')->orderBy('id', 'desc')->first();
    ...
    public function create()
    {
        ...
        $maxId = Aduan::whereDate('created_at', $currentDate->format('Y-m-d'))->where('site', 'MHU')->orderBy('max_id', 'desc')->first();
        ...
        $crew = User::where('site', 'MHU')->where('ict_group', 'Y')->pluck('name')->map(function ($name) {
            return ['name' => $name];
        })->toArray();

        return Inertia::render('Inventory/SiteMhu/Aduan/AduanCreate', ['ticket' => $uniqueString, 'crew' => $crew, 'categories' => $categories]);
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('aduanMhu.page');
    }
    ...
    public function progress($id)
    {
        ...
        return Inertia::render('Inventory/SiteMhu/Aduan/AduanProgress', [
            'aduan' => $aduan,
            'crew' => $crew,
        ]);
    }
    ...
    public function edit($id)
    {
        ...
        return Inertia::render('Inventory/SiteMhu/Aduan/AduanEdit', [
            'aduan' => $aduan,
            'crew' => $crew,
    ...
    public function detail($id)
    {
        ...
        return Inertia::render('Inventory/SiteMhu/Aduan/AduanDetail', [
            'aduan' => $aduan,
        ]);
    }
