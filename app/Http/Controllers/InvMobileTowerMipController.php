...
class InvMobileTowerMipController extends Controller
{
    public function index()
    {
        $dataInventory = InvMobileTower::orderBy('inventory_number', 'desc')->where('site', 'MIP')->get();
        // dd($dataInventory);
        $site = 'MIP';
        $role = auth()->user()->role;

        return Inertia::render('Inventory/MobileTower/mip/MobileTower', ['mobileTower' => $dataInventory, 'site' => $site, 'role' => $role]);
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('mobileTowerMip.page');
    }
    ...
    public function edit($id)
    {
        ...
        return Inertia::render('Inventory/MobileTower/mip/MobileTowerEdit', [
            'mtData' => $mtData,
    ...
    public function detail($id)
    {
        ...
        return Inertia::render('Inventory/MobileTower/mip/MobileTowerDetail', [
