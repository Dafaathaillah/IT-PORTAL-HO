...
class InvScannerWARAController extends Controller
{
    public function index()
    {
        $dataInventory = InvScanner::where('site', 'ADW')->orderBy('scanner_code', 'desc')->get();
        $site = auth()->user()->site;
        $role = auth()->user()->role;
    ...
    public function create()
    {
        ...
        return Inertia::render('Inventory/SiteWARA/Scanner/ScannerCreate', ['inventory_number' => session('inventory_number') ?? null, 'department' => $department]);
    }
    ...
    public function generateCode(Request $request)
    {
        ...
        // dd($uniqueString);
        return redirect()->route('scannerWARA.create')->with([
    ...
    public function generateCodeEdit(Request $request)
    {
        ...
        $uniqueString = $prefix . str_pad(($maxId % 10000) + 1, 3, '0', STR_PAD_LEFT);
        // dd($uniqueString);
        return redirect()->route('scannerWARA.edit', ['id' => $id])
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('scannerWARA.page');
    }
    ...
    public function detail($id)
    {
        ...
        return Inertia::render('Inventory/SiteWARA/Scanner/ScannerDetail', [
            'scanners' => $scanner,
        ]);
    }
    ...
    public function edit($scannerId)
    {
        ...
        if (str_starts_with($inventoryNumber, 'PPAADWSCN')) {
            $company = 'PPA';
        } elseif (str_starts_with($inventoryNumber, 'AMMADWSCN')) {
            $company = 'AMM';
        }
        ...
        return Inertia::render('Inventory/SiteWARA/Scanner/ScannerEdit', [
