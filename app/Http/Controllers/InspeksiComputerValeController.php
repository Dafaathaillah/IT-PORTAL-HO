...
class InspeksiComputerValeController extends Controller
{
    ...
    public function doInspection($id)
    {
        ...
        return Inertia::render('Inspeksi/SiteVale/Komputer/InspeksiKomputerForm', ['inspeksi' => $dataInspeksi, 'crew' => $crew]);
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('inspeksiKomputerVale.page');
    }
    ...
    public function edit($id)
    {
        ...
        return Inertia::render('Inspeksi/SiteVale/Komputer/InspeksiKomputerFormEdit', ['inspeksi' => $dataInspeksi, 'crew' => $crew, 'crew_select' => $crew_select]);
    }
    ...
    public function detail($id)
    {
        ...
        return Inertia::render('Inspeksi/SiteVale/Komputer/InspeksiKomputerDetail', [
