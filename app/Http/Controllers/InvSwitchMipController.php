...
class InvSwitchMipController extends Controller
{
    ...
    public function create()
    {
        ...
        $maxId = InvSwitch::where('site', 'MIP')->orderBy('max_id', 'desc')->first();
        ...
        return Inertia::render('Inventory/SiteMip/Switch/SwitchCreate', ['inventoryNumber' => $uniqueString]);
    }
    ...
    public function edit($swId)
    {
        ...
        return Inertia::render('Inventory/SiteMip/Switch/SwitchEdit', ['switch' => $switch]);
    }
