...
class InspeksiMobileTowerBaController extends Controller
{
    public function index(Request $request)
    {
        ...
        return Inertia::render(
            'Inspeksi/SiteBa/MobileTower/InspeksiMobileTowerView',
            [
    ...
    public function process($id)
    {
        ...
        return Inertia::render('Inspeksi/SiteBa/MobileTower/InspeksiMobileTowerCreate', ['dataInspeksi' => $dataInspeksix, 'pengguna' => $penggunax, 'mobileTower' => $mobileTowerx, 'dataKategori' => $dataKategori, 'subDataKategori' => $subDataKategori, 'totalItems' => $totalItems,]);
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('inspeksiMobileTowerBa.page');
    }
    ...
    public function detail($id)
    {
        ...
        return Inertia::render('Inspeksi/SiteBa/MobileTower/InspeksiMobileTowerDetail', [
    ...
    public function edit($id)
    {
        ...
        return Inertia::render('Inspeksi/SiteBa/MobileTower/InspeksiMobileTowerEdit', ['dataInspeksi' => $dataInspeksix, 'pengguna' => $penggunax, 'mobileTower' => $mobileTowerx, 'dataKategori' => $dataKategori, 'subDataKategori' => $subDataKategori, 'totalItems' => $totalItems,]);
    }
