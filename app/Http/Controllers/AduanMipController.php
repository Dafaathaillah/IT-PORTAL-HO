...
class AduanMipController extends Controller
{
    ...
    {
        $aduanBaru = Aduan::where('site', 'MIP')->orderBy('id', 'desc')->first();
    ...
    public function create()
    {
        ...
        $maxId = Aduan::whereDate('created_at', $currentDate->format('Y-m-d'))->where('site', 'MIP')->orderBy('max_id', 'desc')->first();
        ...
        $crew = User::where('site', 'MIP')->where('ict_group', 'Y')->pluck('name')->map(function ($name) {
            return ['name' => $name];
        })->toArray();

        return Inertia::render('Inventory/SiteMip/Aduan/AduanCreate', ['ticket' => $uniqueString, 'crew' => $crew, 'categories' => $categories]);
    }
    ...
    public function progress($id)
    {
        ...
        return Inertia::render('Inventory/SiteMip/Aduan/AduanProgress', [
            'aduan' => $aduan,
            'crew' => $crew,
    ...
    public function edit($id)
    {
        ...
        return Inertia::render('Inventory/SiteMip/Aduan/AduanEdit', [
            'aduan' => $aduan,
            'crew' => $crew,
    ...
    public function detail($id)
    {
        ...
        return Inertia::render('Inventory/SiteMip/Aduan/AduanDetail', [
            'aduan' => $aduan,
        ]);
    }
