...
class InvMobileTowerAdwController extends Controller
{
    ...
    {
        $dataInventory = InvMobileTower::where('site', 'ADW')->get();
        // dd($dataInventory);
        $site = 'ADW';
        $role = auth()->user()->role;
    ...
    {
        return Inertia::render('Inventory/MobileTower/adw/MobileTowerCreate', ['inventory_number' => session('inventory_number') ?? null]);
    }
