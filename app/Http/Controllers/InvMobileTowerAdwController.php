...
class InvMobileTowerAdwController extends Controller
{
    public function index()
    {
        $dataInventory = InvMobileTower::orderBy('inventory_number', 'desc')->where('site', 'ADW')->get();
        // dd($dataInventory);
        $site = 'ADW';
        $role = auth()->user()->role;

        return Inertia::render('Inventory/MobileTower/adw/MobileTower', ['mobileTower' => $dataInventory, 'site' => $site, 'role' => $role]);
    }
    public function create()
    {
        ...
        return Inertia::render('Inventory/MobileTower/adw/MobileTowerCreate', ['inventoryNumber' => $site . '-MT-' . $nextNumber]);
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('mobileTowerAdw.page');
    }
    ...
    public function edit($id)
    {
        ...
        return Inertia::render('Inventory/MobileTower/adw/MobileTowerEdit', [
            'mtData' => $mtData,
    ...
    public function detail($id)
    {
        ...
        return Inertia::render('Inventory/MobileTower/adw/MobileTowerDetail', [
