...
class AduanSksController extends Controller
{
    public function index()
    {

        $aduan = Aduan::where('site', 'SKS')
    ...
    public function create()
    {
        ...
        $maxId = Aduan::whereDate('created_at', $currentDate->format('Y-m-d'))->where('site', 'SKS')->orderBy('max_id', 'desc')->first();
        ...
        $crew = User::where('site', 'SKS')->where('ict_group', 'Y')->pluck('name')->map(function ($name) {
            return ['name' => $name];
        })->toArray();

        return Inertia::render('Inventory/SiteSks/Aduan/AduanCreate', ['ticket' => $uniqueString, 'crew' => $crew, 'categories' => $categories]);
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('aduanSks.page');
    }
    ...
    public function progress($id)
    {
        ...
        return Inertia::render('Inventory/SiteSks/Aduan/AduanProgress', [
            'aduan' => $aduan,
            'crew' => $crew,
        ]);
    }
    ...
    public function edit($id)
    {
        ...
        $crew = User::where('site', 'SKS')->where('ict_group', 'Y')->where('ict_group', 'Y')->pluck('name')->map(function ($name) {
            return ['name' => $name];
        })->toArray();
        return Inertia::render('Inventory/SiteSks/Aduan/AduanEdit', [
            'aduan' => $aduan,
            'crew' => $crew,
    ...
    public function detail($id)
    {
        ...
        return Inertia::render('Inventory/SiteSks/Aduan/AduanDetail', [
            'aduan' => $aduan,
        ]);
    }
