...
class InspeksiComputerIptController extends Controller
{
    ...
    public function doInspection($id)
    {
        ...
        return Inertia::render('Inspeksi/SiteIpt/Komputer/InspeksiKomputerForm', ['inspeksi' => $dataInspeksi, 'crew' => $crew]);
    }
    ...
    public function store(Request $request)
    {
        ...
        $maxId = InspeksiComputer::where('site', 'IPT')->where('year', $year)->max('pica_number');
        ...
        return redirect()->route('inspeksiKomputerIpt.page');
    }
    ...
    public function edit($id)
    {
        ...
        return Inertia::render('Inspeksi/SiteIpt/Komputer/InspeksiKomputerFormEdit', ['inspeksi' => $dataInspeksi, 'crew' => $crew, 'crew_select' => $crew_select]);
    }
    ...
    public function detail($id)
    {
        ...
        return Inertia::render('Inspeksi/SiteIpt/Komputer/InspeksiKomputerDetail', [
