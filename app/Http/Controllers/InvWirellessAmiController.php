...
class InvWirellessAmiController extends Controller
{
    ...
    public function create()
    {
        ...
        $maxId = InvWirelless::where('site', 'AMI')->orderBy('max_id', 'desc')->first();
        ...
        $uniqueString = 'PPAAMIBB' . str_pad(($maxId % 10000) + 1, 3, '0', STR_PAD_LEFT);

        $request['inventory_number'] = $uniqueString;
        // end generate code

        return Inertia::render('Inventory/SiteAmi/Wirelless/WirellessCreate', ['inventoryNumber' => $uniqueString]);
    }
    ...
    public function edit($id)
    {
        ...
        return Inertia::render('Inventory/SiteAmi/Wirelless/WirellessEdit', ['wirelless' => $wirelless]);
    }
