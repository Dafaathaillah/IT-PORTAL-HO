...
class InvPrinterMlpController extends Controller
{
    ...
    public function create()
    {
        ...
        $maxId = InvPrinter::where('site', 'MLP')->orderBy('max_id', 'desc')->first();
        ...
        $uniqueString = 'PPAMLPPRT' . str_pad(($maxId % 10000) + 1, 3, '0', STR_PAD_LEFT);
        ...
        return Inertia::render('Inventory/SiteMlp/Printer/PrinterCreate', ['printer_code' => $uniqueString, 'department' => $department]);
    }
    ...
    public function edit($printerId)
    {
        ...
        return Inertia::render('Inventory/SiteMlp/Printer/PrinterEdit', ['printer' => $printer, 'department' => $department, 'department_select' => $department_select]);
    }
