...
class InvApMlpController extends Controller
{
    public function index()
    {
        ...
        return Inertia::render('Inventory/SiteMlp/AccessPoint/AccessPoint', ['accessPoint' => $dataInventory, 'site' => $site, 'role' => $role]);
    }

    public function create()
    {
        return Inertia::render('Inventory/SiteMlp/AccessPoint/AccessPointCreate', ['inventory_number' => session('inventory_number') ?? null]);
    }
    ...
    public function generateCode(Request $request)
    {
        ...
        $prefix = $dataCompany === 'PPA' ? 'PPAMLPAP' : 'AMMMLPAP';
        ...
        // dd($uniqueString);
        return redirect()->route('accessPointMlp.create')->with([
    ...
    public function generateCodeEdit(Request $request)
    {
        ...
        $uniqueString = $prefix . str_pad(($maxId % 10000) + 1, 3, '0', STR_PAD_LEFT);
        // dd($uniqueString);
        return redirect()->route('accessPointMlp.edit', ['apId' => $id])
    ...
    public function edit($apId)
    {
        ...
        if (str_starts_with($inventoryNumber, 'PPAMLPAP')) {
            $company = 'PPA';
        } elseif (str_starts_with($inventoryNumber, 'AMMMLPAP')) {
            $company = 'AMM';
        }

        return Inertia::render('Inventory/SiteMlp/AccessPoint/AccessPointEdit', [
    ...
    public function detail($id)
    {
        ...
        return Inertia::render('Inventory/SiteMlp/AccessPoint/AccessPointDetail', [
