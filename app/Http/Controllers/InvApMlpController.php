...
class InvApMlpController extends Controller
{
    ...
    public function create()
    {
        ...
        if (auth()->user()->role == 'ict_developer' || auth()->user()->site == 'MLP') {
            $maxId = InvAp::where('site', 'MLP')->orderBy('max_id', 'desc')->first();
            ...
            $uniqueString = 'PPAMLPAP' . str_pad(($maxId % 10000) + 1, 3, '0', STR_PAD_LEFT);
        } else {
            $maxId = '';
        ...
        return Inertia::render('Inventory/SiteMlp/AccessPoint/AccessPointCreate', ['inventoryNumber' => $uniqueString]);
    }
    ...
    public function edit($apId)
    {
        ...
        return Inertia::render('Inventory/SiteMlp/AccessPoint/AccessPointEdit', ['accessPoint' => $accessPoint]);
    }
