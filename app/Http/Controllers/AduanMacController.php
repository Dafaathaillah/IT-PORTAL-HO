...
class AduanMacController extends Controller
{
    ...
    {
        $aduanBaru = Aduan::where('site', 'MAC')->orderBy('id', 'desc')->first();
    ...
    public function create()
    {
        ...
        $maxId = Aduan::whereDate('created_at', $currentDate->format('Y-m-d'))->where('site', 'MAC')->orderBy('max_id', 'desc')->first();
        ...
        $crew = User::where('site', 'MAC')->where('ict_group', 'Y')->pluck('name')->map(function ($name) {
            return ['name' => $name];
        })->toArray();

        return Inertia::render('Inventory/SiteMac/Aduan/AduanCreate', ['ticket' => $uniqueString, 'crew' => $crew, 'categories' => $categories]);
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('aduanMac.page');
    }
    ...
    public function progress($id)
    {
        ...
        return Inertia::render('Inventory/SiteMac/Aduan/AduanProgress', [
            'aduan' => $aduan,
            'crew' => $crew,
    ...
    public function edit($id)
    {
        ...
        $crew = User::where('site', 'MAC')->where('ict_group', 'Y')->where('ict_group', 'Y')->pluck('name')->map(function ($name) {
            return ['name' => $name];
        })->toArray();
        return Inertia::render('Inventory/SiteMac/Aduan/AduanEdit', [
            'aduan' => $aduan,
            'crew' => $crew,
    ...
    public function detail($id)
    {
        ...
        return Inertia::render('Inventory/SiteMac/Aduan/AduanDetail', [
            'aduan' => $aduan,
        ]);
    }
