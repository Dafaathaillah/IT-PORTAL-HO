...
class PicaInspeksiController extends Controller
{
    ...
    // {
    //     $site = $request->site;
    //     if ($request->device === 'Laptop') {
    //         $dataPica = InspeksiComputer::with('computer.pengguna')
    //             ->where('site', $site)
    //             ->whereNotNull('findings_image')
    ...
    //         $qr_base64Pic = null;
    //         $picInspeksi = User::where('name', $request->pic)->first();
    ...
    //     } else {
    //         $dataPica = InspeksiLaptop::with('inventory.pengguna')
    //             ->where('site', $site)
    //             ->whereNotNull('findings_image')
    //             ->whereBetween('created_date', [$request->startDate, $request->endDate])
    //             ->get()->map(function ($item) {
    ...
    //     $pdf = Pdf::loadView('itportal.rekapAllInspeksi.inspeksiLaptopAll', compact('dataPica', 'thisYear', 'unitScrap', 'unitUtilize', 'site', 'pic', 'picApproved', 'qr_base64Approved', 'qr_base64Pic'))
