...
class InvWirellessBgeController extends Controller
{
    ...
    public function create()
    {
        ...
        $maxId = InvWirelless::where('site', 'BGE')->orderBy('max_id', 'desc')->first();
        ...
        $uniqueString = 'PPABGEBB' . str_pad(($maxId % 10000) + 1, 3, '0', STR_PAD_LEFT);

        $request['inventory_number'] = $uniqueString;
        // end generate code

        return Inertia::render('Inventory/SiteBge/Wirelless/WirellessCreate', ['inventoryNumber' => $uniqueString]);
    }
    ...
    public function edit($id)
    {
        ...
        return Inertia::render('Inventory/SiteBge/Wirelless/WirellessEdit', ['wirelless' => $wirelless]);
    }
