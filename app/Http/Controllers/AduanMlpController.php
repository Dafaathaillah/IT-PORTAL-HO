...
class AduanMlpController extends Controller
{
    public function index()
    {

        $aduan = Aduan::where('site', 'MLP')
    ...
    {
        $aduanBaru = Aduan::where('site', 'MLP')->orderBy('id', 'desc')->first();
    ...
    public function create()
    {
        ...
        $maxId = Aduan::whereDate('created_at', $currentDate->format('Y-m-d'))->where('site', 'MLP')->orderBy('max_id', 'desc')->first();
        ...
        $crew = User::where('site', 'MLP')->where('ict_group', 'Y')->pluck('name')->map(function ($name) {
            return ['name' => $name];
        })->toArray();

        return Inertia::render('Inventory/SiteMlp/Aduan/AduanCreate', ['ticket' => $uniqueString, 'crew' => $crew, 'categories' => $categories]);
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('aduanMlp.page');
    }
    ...
    public function progress($id)
    {
        ...
        return Inertia::render('Inventory/SiteMlp/Aduan/AduanProgress', [
            'aduan' => $aduan,
            'crew' => $crew,
        ]);
    }
    ...
    public function edit($id)
    {
        ...
        return Inertia::render('Inventory/SiteMlp/Aduan/AduanEdit', [
            'aduan' => $aduan,
            'crew' => $crew,
    ...
    public function detail($id)
    {
        ...
        return Inertia::render('Inventory/SiteMlp/Aduan/AduanDetail', [
            'aduan' => $aduan,
        ]);
    }
