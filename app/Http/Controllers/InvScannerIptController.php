...
class InvScannerIptController extends Controller
{
    public function index()
    {
        $dataInventory = InvScanner::where('site', 'IPT')->orderBy('scanner_code', 'desc')->get();
        $site = auth()->user()->site;
        $role = auth()->user()->role;
        return Inertia::render('Inventory/SiteIpt/Scanner/Scanner', ['scanner' => $dataInventory, 'site' => $site, 'role' => $role]);
    }
    ...
    public function create()
    {
        ...
        return Inertia::render('Inventory/SiteIpt/Scanner/ScannerCreate', ['inventory_number' => session('inventory_number') ?? null, 'department' => $department]);
    }
    ...
    public function generateCode(Request $request)
    {
        ...
        // dd($uniqueString);
        return redirect()->route('scannerIpt.create')->with([
    ...
    public function generateCodeEdit(Request $request)
    {
        ...
        $uniqueString = $prefix . str_pad(($maxId % 10000) + 1, 3, '0', STR_PAD_LEFT);
        // dd($uniqueString);
        return redirect()->route('scannerIpt.edit', ['id' => $id])
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('scannerIpt.page');
    }
    ...
    public function detail($id)
    {
        ...
        return Inertia::render('Inventory/SiteIpt/Scanner/ScannerDetail', [
            'scanners' => $scanner,
        ]);
    }
    ...
    public function edit($scannerId)
    {
        ...
        if (str_starts_with($inventoryNumber, 'PPAIPTSCN')) {
            $company = 'PPA';
        } elseif (str_starts_with($inventoryNumber, 'AMMIPTSCN')) {
            $company = 'AMM';
        }
        ...
        return Inertia::render('Inventory/SiteIpt/Scanner/ScannerEdit', [
