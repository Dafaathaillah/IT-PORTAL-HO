...
class InvScannerIptController extends Controller
{
    ...
    public function create()
    {
        ...
        $maxId = InvScanner::where('site', 'IPT')->orderBy('max_id', 'desc')->first();
        ...
        $uniqueString = 'PPAIPTSCN' . str_pad(($maxId % 10000) + 1, 3, '0', STR_PAD_LEFT);
        ...
        return Inertia::render('Inventory/SiteIpt/Scanner/ScannerCreate', ['scanner_code' => $uniqueString, 'department' => $department]);
    }
    ...
    public function edit($id)
    {
        ...
        return Inertia::render('Inventory/SiteIpt/Scanner/ScannerEdit', ['scanner' => $scanner, 'department' => $department, 'department_select' => $department_select]);
    }
