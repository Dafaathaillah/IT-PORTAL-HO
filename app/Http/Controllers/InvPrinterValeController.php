...
class InvPrinterValeController extends Controller
{
    public function index()
    {
        $dataInventory = InvPrinter::where('site', 'VIB')->orderBy('printer_code', 'desc')->get();
        $site = auth()->user()->site;
        $role = auth()->user()->role;

        return Inertia::render('Inventory/SiteVale/Printer/Printer', ['printer' => $dataInventory, 'site' => $site, 'role' => $role]);
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('printerVale.page');
    }
    ...
    public function uploadCsv(Request $request)
    {
        try {
            ...
            // dd($duplicates);
            return Redirect::route('printerVale.page')->with([
    ...
    public function detail($id)
    {
        ...
        return Inertia::render('Inventory/SiteVale/Printer/PrinterDetail', [
            'printers' => $printer,
        ]);
    }
