...
class InspeksiLaptopMacController extends Controller
{
    public function index(Request $request)
    {
        ...
        $inspeksi_laptop = InspeksiLaptop::with('inventory.pengguna')->where('site', 'MAC')->where('year', $yearNow)->get();
        $crew = User::whereIn('role', ['ict_technician', 'ict_group_leader'])->where('site', 'MAC')->pluck('name')->map(function ($name) {
            return ['name' => $name];
        })->toArray();
        ...
        return Inertia::render(
            'Inspeksi/SiteMac/Laptop/InspeksiLaptopView',
    ...
    public function process($id)
    {
        ...
        $penggunax = User::whereIn('role', ['ict_technician', 'ict_group_leader'])->where('site', 'MAC')->pluck('name')->map(function ($name) {
            return ['name' => $name];
        })->toArray();

        return Inertia::render('Inspeksi/SiteMac/Laptop/InspeksiLaptopCreate', ['dataInspeksi' => $dataInspeksix, 'pengguna' => $penggunax, 'laptop' => $laptopx]);
    }
    ...
    public function store(Request $request)
    {
        ...
        $maxId = InspeksiLaptop::where('site', "MAC")->where('year', $year)->max('pica_number');
        ...
        return redirect()->route('inspeksiLaptopMac.page');
    }
    ...
    public function edit($id)
    {
        ...
        return Inertia::render('Inspeksi/SiteMac/Laptop/InspeksiLaptopEdit', ['dataInspeksi' => $dataInspeksix, 'pengguna' => $penggunax, 'laptop' => $laptopx, 'pengguna_selected' => $pengguna_selected]);
    }
    ...
    public function approval(Request $request)
    {
        ...
        $site = 'MAC'; // fallback jika site tidak tersedia
    ...
    public function detail($id)
    {
        ...
        return Inertia::render('Inspeksi/SiteMac/Laptop/InspeksiLaptopDetail', [
