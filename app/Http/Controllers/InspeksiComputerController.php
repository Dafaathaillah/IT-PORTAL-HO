...
class InspeksiComputerController extends Controller
{
    ...
    public function index()
    {
        ...
        $crew = User::whereIn('role', ['ict_ho', 'ict_bod'])->where('site', 'HO')->pluck('name')->map(function ($name) {
            return ['name' => $name];
        })->toArray();
    ...
    public function doInspection($id)
    {
        ...
        return Inertia::render('Inspeksi/Komputer/InspeksiKomputerForm', ['inspeksi' => $dataInspeksi, 'crew' => $crew]);
    }
    ...
    public function store(Request $request)
    {
        ...
        $maxId = InspeksiComputer::where('site', 'HO')->where('year', $year)->max('pica_number');
