...
class InspeksiMobileTowerAmiController extends Controller
{
    public function index(Request $request)
    {
        ...
        return Inertia::render(
            'Inspeksi/SiteAmi/MobileTower/InspeksiMobileTowerView',
            [
    ...
    public function process($id)
    {
        ...
        return Inertia::render('Inspeksi/SiteAmi/MobileTower/InspeksiMobileTowerCreate', ['dataInspeksi' => $dataInspeksix, 'pengguna' => $penggunax, 'mobileTower' => $mobileTowerx, 'dataKategori' => $dataKategori, 'subDataKategori' => $subDataKategori, 'totalItems' => $totalItems,]);
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('inspeksiMobileTowerAmi.page');
    }
    ...
    public function detail($id)
    {
        ...
        return Inertia::render('Inspeksi/SiteAmi/MobileTower/InspeksiMobileTowerDetail', [
    ...
    public function edit($id)
    {
        ...
        return Inertia::render('Inspeksi/SiteAmi/MobileTower/InspeksiMobileTowerEdit', ['dataInspeksi' => $dataInspeksix, 'pengguna' => $penggunax, 'mobileTower' => $mobileTowerx, 'dataKategori' => $dataKategori, 'subDataKategori' => $subDataKategori, 'totalItems' => $totalItems,]);
    }
