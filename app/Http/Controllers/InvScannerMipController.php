...
class InvScannerMipController extends Controller
{
    ...
    public function create()
    {
        ...
        return Inertia::render('Inventory/SiteMip/Scanner/ScannerCreate', ['inventory_number' => session('inventory_number') ?? null, 'department' => $department]);
    }
    ...
    public function generateCode(Request $request)
    {
        ...
        // dd($uniqueString);
        return redirect()->route('scannerMip.create')->with([
    ...
    public function generateCodeEdit(Request $request)
    {
        ...
        $uniqueString = $prefix . str_pad(($maxId % 10000) + 1, 3, '0', STR_PAD_LEFT);
        // dd($uniqueString);
        return redirect()->route('scannerMip.edit', ['id' => $id])
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('scannerMip.page');
    }
    ...
    public function detail($id)
    {
        ...
        return Inertia::render('Inventory/SiteMip/Scanner/ScannerDetail', [
            'scanners' => $scanner,
        ]);
    }
    ...
    public function edit($scannerId)
    {
        ...
        if (str_starts_with($inventoryNumber, 'PPAMIPSCN')) {
            $company = 'PPA';
        } elseif (str_starts_with($inventoryNumber, 'AMMMIPSCN')) {
            $company = 'AMM';
        }
        ...
        return Inertia::render('Inventory/SiteMip/Scanner/ScannerEdit', [
