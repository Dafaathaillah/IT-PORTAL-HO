...
class InspeksiMobileTowerAdwController extends Controller
{
    public function index(Request $request)
    {
        ...
        return Inertia::render(
            'Inspeksi/SiteWARA/MobileTower/InspeksiMobileTowerView',
            [
    ...
    public function process($id)
    {
        ...
        return Inertia::render('Inspeksi/SiteWARA/MobileTower/InspeksiMobileTowerCreate', ['dataInspeksi' => $dataInspeksix, 'pengguna' => $penggunax, 'mobileTower' => $mobileTowerx, 'dataKategori' => $dataKategori, 'subDataKategori' => $subDataKategori, 'totalItems' => $totalItems,]);
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('inspeksiMobileTowerAdw.page');
    }
    ...
    public function detail($id)
    {
        ...
        return Inertia::render('Inspeksi/SiteWARA/MobileTower/InspeksiMobileTowerDetail', [
    ...
    public function edit($id)
    {
        ...
        return Inertia::render('Inspeksi/SiteWARA/MobileTower/InspeksiMobileTowerEdit', ['dataInspeksi' => $dataInspeksix, 'pengguna' => $penggunax, 'mobileTower' => $mobileTowerx, 'dataKategori' => $dataKategori, 'subDataKategori' => $subDataKategori, 'totalItems' => $totalItems,]);
    }
