...
class InvPrinterDmpController extends Controller
{
    public function index()
    {
        $dataInventory = InvPrinter::where('site', 'DMP')->orderBy('printer_code', 'desc')->get();
        $site = auth()->user()->site;
        $role = auth()->user()->role;

        return Inertia::render('Inventory/SiteDmp/Printer/Printer', ['printer' => $dataInventory, 'site' => $site, 'role' => $role]);
    }
    ...
    public function create()
    {
        ...
        return Inertia::render('Inventory/SiteDmp/Printer/PrinterCreate', ['inventory_number' => session('inventory_number') ?? null, 'department' => $department]);
    }
    ...
    public function generateCode(Request $request)
    {
        ...
        // dd($uniqueString);
        return redirect()->route('printerDmp.create')->with([
    ...
    public function generateCodeEdit(Request $request)
    {
        ...
        $uniqueString = $prefix . str_pad(($maxId % 10000) + 1, 3, '0', STR_PAD_LEFT);
        // dd($uniqueString);
        return redirect()->route('printerDmp.edit', ['id' => $id])
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('printerDmp.page');
    }
    ...
    public function uploadCsv(Request $request)
    {
        try {
            ...
            // dd($duplicates);
            return Redirect::route('printerDmp.page')->with([
    ...
    public function detail($id)
    {
        ...
        return Inertia::render('Inventory/SiteDmp/Printer/PrinterDetail', [
            'printers' => $printer,
        ]);
    }
    ...
    public function edit($printerId)
    {
        ...
        if (str_starts_with($inventoryNumber, 'PPADMPPRT')) {
            $company = 'PPA';
        } elseif (str_starts_with($inventoryNumber, 'AMMDMPPRT')) {
            $company = 'AMM';
        }
        ...
        return Inertia::render('Inventory/SiteDmp/Printer/PrinterEdit', [
            'printer' => $printer,
