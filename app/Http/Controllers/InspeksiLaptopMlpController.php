...
class InspeksiLaptopMlpController extends Controller
{
    public function index(Request $request)
    {
        ...
        $inspeksi_laptop = InspeksiLaptop::with('inventory.pengguna')->where('site', 'MLP')->where('year', $yearNow)->get();
    ...
    public function process($id)
    {
        ...
        $penggunax = User::whereIn('role', ['ict_technician', 'ict_group_leader'])->where('site', 'MLP')->pluck('name')->map(function ($name) {
            return ['name' => $name];
        })->toArray();

        return Inertia::render('Inspeksi/SiteMlp/Laptop/InspeksiLaptopCreate', ['dataInspeksi' => $dataInspeksix, 'pengguna' => $penggunax, 'laptop' => $laptopx]);
    }
    ...
    public function store(Request $request)
    {
        ...
        $maxId = InspeksiLaptop::where('site', "MLP")->where('year', $year)->max('pica_number');
        ...
        return redirect()->route('inspeksiLaptopMlp.page');
    }
    ...
    public function edit($id)
    {
        ...
        return Inertia::render('Inspeksi/SiteMlp/Laptop/InspeksiLaptopEdit', ['dataInspeksi' => $dataInspeksix, 'pengguna' => $penggunax, 'laptop' => $laptopx, 'pengguna_selected' => $pengguna_selected]);
    }
    ...
    public function approval(Request $request)
    {
        ...
        $site = 'MLP'; // fallback jika site tidak tersedia
    ...
    public function detail($id)
    {
        ...
        return Inertia::render('Inspeksi/SiteMlp/Laptop/InspeksiLaptopDetail', [
