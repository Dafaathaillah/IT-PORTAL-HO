...
class InvComputerPikController extends Controller
{
    public function index()
    {
        $dataInventory = InvComputer::with('pengguna')->orderBy('max_id', 'desc')->where('site', 'PIK')->get();
        ...
        return Inertia::render('Inventory/SitePik/Komputer/Komputer', ['komputer' => $dataInventory, 'site' => $site, 'role' => $role, 'department' => $department]);
    }
    ...
    public function create()
    {
        ...
        $pengguna = UserAll::where('site', 'PIK')->select('username', 'nrp', 'department')->get()->map(function ($item) {
            return [
                'nrp' => $item->nrp,
                'name' => $item->username,
    ...
    public function store(Request $request)
    {
        ...
        $aduan_get_data_user = UserAll::where('site', 'PIK')->where('nrp', $params['user_alls_id'])->first();
    ...
    public function edit($id)
    {
        ...
        $pengguna_all = UserAll::where('site', 'PIK')->select('username', 'nrp', 'department')->get()->map(function ($item) {
            return [
                'nrp' => $item->nrp,
                'name' => $item->username,
                'dept' => $item->department,
        ...
        return Inertia::render('Inventory/SitePik/Komputer/KomputerEdit', [
            'komputer' => $komputer,
            'model' => $model,
            'processor' => $processor,
            'hdd' => $hdd,
    ...
    public function detail($id)
    {
        ...
        return Inertia::render('Inventory/SitePik/Komputer/KomputerDetail', [
            'komputer' => $komputer,
            'aduan' => $aduan,
        ]);
    }
    ...
    public function update(Request $request)
    {
        if (!empty($request->hasFile('image'))) {
            ...
            $aduan_get_data_user = UserAll::where('site', 'PIK')->where('nrp', $request->user_alls_id)->first();
