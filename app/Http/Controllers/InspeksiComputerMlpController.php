...
class InspeksiComputerMlpController extends Controller
{
    public function index()
    {
        $inspeksi_computer = InspeksiComputer::with('computer.pengguna')->where('site', 'MLP')->get();
        ...
        return Inertia::render(
            'Inspeksi/SiteMlp/Komputer/InspeksiKomputerIndex',
    ...
    public function doInspection($id)
    {
        ...
        $crew = User::where('site', 'MLP')->pluck('name')->map(function ($name) {
            return ['name' => $name];
        })->toArray();
        // return dd($dataInspeksi);
        return Inertia::render('Inspeksi/SiteMlp/Komputer/InspeksiKomputerForm', ['inspeksi' => $dataInspeksi, 'crew' => $crew]);
    }
    ...
    public function store(Request $request)
    {
        ...
        $maxId = InspeksiComputer::where('site', 'MLP')->where('year', $year)->max('pica_number');
        ...
        return redirect()->route('inspeksiKomputerMlp.page');
    }
    ...
    public function edit($id)
    {
        ...
        return Inertia::render('Inspeksi/SiteMlp/Komputer/InspeksiKomputerFormEdit', ['inspeksi' => $dataInspeksi, 'crew' => $crew, 'crew_select' => $crew_select]);
    }
    ...
    public function detail($id)
    {
        ...
        return Inertia::render('Inspeksi/SiteMlp/Komputer/InspeksiKomputerDetail', [
