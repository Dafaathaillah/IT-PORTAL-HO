...
class InvMobileTowerBibController extends Controller
{
    ...
    {
        $dataInventory = InvMobileTower::orderBy('inventory_number', 'desc')->where('site', 'BIB')->get();
        // dd($dataInventory);
        $site = 'BIB';
        $role = auth()->user()->role;
    ...
    public function create()
    {
        ...
        return Inertia::render('Inventory/MobileTower/bib/MobileTowerCreate', ['inventoryNumber' => $site . '-MT-' . $nextNumber]);
    }
