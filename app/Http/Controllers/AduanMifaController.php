...
class AduanMifaController extends Controller
{
    ...
    ")
        ...
        return Inertia::render(
            'Inventory/SiteMifa/Aduan/Aduan',
            [
                'aduan' => $aduan,
                'open' => $countOpen,
                'closed' => $countClosed,
    ...
    public function create()
    {
        ...
        $maxId = Aduan::whereDate('created_at', $currentDate->format('Y-m-d'))->where('site', 'MIFA')->orderBy('max_id', 'desc')->first();
        ...
        $crew = User::where('site', 'MIFA')->where('ict_group', 'Y')->pluck('name')->map(function ($name) {
            return ['name' => $name];
        })->toArray();

        return Inertia::render('Inventory/SiteMifa/Aduan/AduanCreate', ['ticket' => $uniqueString, 'crew' => $crew, 'categories' => $categories]);
    }
    ...
    public function progress($id)
    {
        ...
        return Inertia::render('Inventory/SiteMifa/Aduan/AduanProgress', [
            'aduan' => $aduan,
            'crew' => $crew,
        ]);
    }
    ...
    public function edit($id)
    {
        ...
        return Inertia::render('Inventory/SiteMifa/Aduan/AduanEdit', [
            'aduan' => $aduan,
            'crew' => $crew,
    ...
    public function detail($id)
    {
        ...
        return Inertia::render('Inventory/SiteMifa/Aduan/AduanDetail', [
            'aduan' => $aduan,
        ]);
    }
