...
class InvWirellessMhuController extends Controller
{
    ...
    {
        return Inertia::render('Inventory/SiteMhu/Wirelless/WirellessCreate', ['inventory_number' => session('inventory_number') ?? null]);
    }
    ...
    public function generateCode(Request $request)
    {
        ...
        $prefix = $dataCompany === 'PPA' ? 'PPAMHUBB' : 'AMMMHUBB';
        ...
        // dd($uniqueString);
        return redirect()->route('wirellessMhu.create')->with([
    ...
    public function generateCodeEdit(Request $request)
    {
        ...
        $uniqueString = $prefix . str_pad(($maxId % 10000) + 1, 3, '0', STR_PAD_LEFT);
        // dd($uniqueString);
        return redirect()->route('wirellessMhu.edit', ['id' => $id])
    ...
    public function uploadCsv(Request $request)
    {
        try {
            ...
            // dd($duplicates);
            return Redirect::route('wirellessMhu.page')->with([
    ...
    public function edit($id)
    {
        ...
        return Inertia::render('Inventory/SiteMhu/Wirelless/WirellessEdit', [
            'wirelless' => $wirelless,
