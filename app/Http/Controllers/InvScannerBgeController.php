...
class InvScannerBgeController extends Controller
{
    ...
    public function create()
    {
        ...
        return Inertia::render('Inventory/SiteBge/Scanner/ScannerCreate', ['inventory_number' => session('inventory_number') ?? null, 'department' => $department]);
    }
    ...
    public function generateCode(Request $request)
    {
        ...
        // dd($uniqueString);
        return redirect()->route('scannerBge.create')->with([
    ...
    public function generateCodeEdit(Request $request)
    {
        ...
        $uniqueString = $prefix . str_pad(($maxId % 10000) + 1, 3, '0', STR_PAD_LEFT);
        // dd($uniqueString);
        return redirect()->route('scannerBge.edit', ['id' => $id])
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('scannerBge.page');
    }
    ...
    public function detail($id)
    {
        ...
        return Inertia::render('Inventory/SiteBge/Scanner/ScannerDetail', [
            'scanners' => $scanner,
        ]);
    }
    ...
    public function edit($scannerId)
    {
        ...
        if (str_starts_with($inventoryNumber, 'PPABGESCN')) {
            $company = 'PPA';
        } elseif (str_starts_with($inventoryNumber, 'AMMBGESCN')) {
            $company = 'AMM';
        }
        ...
        return Inertia::render('Inventory/SiteBge/Scanner/ScannerEdit', [
