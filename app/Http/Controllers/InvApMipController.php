...
class InvApMipController extends Controller
{
    public function index()
    {
        ...
        return Inertia::render('Inventory/SiteMip/AccessPoint/AccessPoint', ['accessPoint' => $dataInventory, 'site' => $site, 'role' => $role]);
    }

    public function create()
    {
        return Inertia::render('Inventory/SiteMip/AccessPoint/AccessPointCreate', ['inventory_number' => session('inventory_number') ?? null]);
    }
    ...
    public function generateCode(Request $request)
    {
        ...
        $prefix = $dataCompany === 'PPA' ? 'PPAMIPAP' : 'AMMMIPAP';
        ...
        // dd($uniqueString);
        return redirect()->route('accessPointMip.create')->with([
    ...
    public function generateCodeEdit(Request $request)
    {
        ...
        $uniqueString = $prefix . str_pad(($maxId % 10000) + 1, 3, '0', STR_PAD_LEFT);
        // dd($uniqueString);
        return redirect()->route('accessPointMip.edit', ['apId' => $id])
    ...
    public function store(Request $request)
    {
        ...
        InvAp::create($data);
        return redirect()->route('accessPointMip.page');
    }
    ...
    public function uploadCsv(Request $request)
    {
        try {
            ...
            // dd($duplicates);
            return Redirect::route('accessPointMip.page')->with([
    ...
    public function edit($apId)
    {
        ...
        if (str_starts_with($inventoryNumber, 'PPAMIPAP')) {
            $company = 'PPA';
        } elseif (str_starts_with($inventoryNumber, 'AMMMIPAP')) {
            $company = 'AMM';
        }

        return Inertia::render('Inventory/SiteMip/AccessPoint/AccessPointEdit', [
    ...
    public function detail($id)
    {
        ...
        return Inertia::render('Inventory/SiteMip/AccessPoint/AccessPointDetail', [
