...
class InvApMipController extends Controller
{
    ...
    public function create()
    {
        ...
        if (auth()->user()->role == 'ict_developer' || auth()->user()->site == 'MIP') {
            $maxId = InvAp::where('site', 'MIP')->orderBy('max_id', 'desc')->first();
            ...
            $uniqueString = 'PPAMIPAP' . str_pad(($maxId % 10000) + 1, 3, '0', STR_PAD_LEFT);
        } else {
            $maxId = '';
        ...
        return Inertia::render('Inventory/SiteMip/AccessPoint/AccessPointCreate', ['inventoryNumber' => $uniqueString]);
    }
    ...
    public function edit($apId)
    {
        ...
        return Inertia::render('Inventory/SiteMip/AccessPoint/AccessPointEdit', ['accessPoint' => $accessPoint]);
    }
