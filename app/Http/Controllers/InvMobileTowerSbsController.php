...
class InvMobileTowerSbsController extends Controller
{
    public function index()
    {
        $dataInventory = InvMobileTower::where('site', 'SBS')->get();
        // dd($dataInventory);
        $site = 'SBS';
        $role = auth()->user()->role;

        return Inertia::render('Inventory/MobileTower/sbs/MobileTower', ['mobileTower' => $dataInventory, 'site' => $site, 'role' => $role]);
    }
    public function create()
    {
        return Inertia::render('Inventory/MobileTower/sbs/MobileTowerCreate', ['inventory_number' => session('inventory_number') ?? null]);
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('mobileTowerSbs.page');
    }
    ...
    public function edit($id)
    {
        ...
        return Inertia::render('Inventory/MobileTower/sbs/MobileTowerEdit', [
            'mtData' => $mtData,
    ...
    public function detail($id)
    {
        ...
        return Inertia::render('Inventory/MobileTower/sbs/MobileTowerDetail', [
