...
class InvMobileTowerMhuController extends Controller
{
    ...
    {
        $dataInventory = InvMobileTower::where('site', 'MHU')->get();
        // dd($dataInventory);
        $site = 'MHU';
        $role = auth()->user()->role;
    ...
    {
        return Inertia::render('Inventory/MobileTower/mhu/MobileTowerCreate', ['inventory_number' => session('inventory_number') ?? null]);
    }
