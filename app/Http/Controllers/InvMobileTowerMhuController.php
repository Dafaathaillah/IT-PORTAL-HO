...
class InvMobileTowerMhuController extends Controller
{
    public function index()
    {
        $dataInventory = InvMobileTower::orderBy('inventory_number', 'desc')->where('site', 'MHU')->get();
        // dd($dataInventory);
        $site = 'MHU';
        $role = auth()->user()->role;

        return Inertia::render('Inventory/MobileTower/mhu/MobileTower', ['mobileTower' => $dataInventory, 'site' => $site, 'role' => $role]);
    }
    public function create()
    {
        ...
        return Inertia::render('Inventory/MobileTower/mhu/MobileTowerCreate', ['inventoryNumber' => $site . '-MT-' . $nextNumber]);
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('mobileTowerMhu.page');
    }
    ...
    public function edit($id)
    {
        ...
        return Inertia::render('Inventory/MobileTower/mhu/MobileTowerEdit', [
            'mtData' => $mtData,
    ...
    public function detail($id)
    {
        ...
        return Inertia::render('Inventory/MobileTower/mhu/MobileTowerDetail', [
