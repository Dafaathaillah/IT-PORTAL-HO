...
class InvWirellessIptController extends Controller
{
    public function index()
    {
        ...
        return Inertia::render('Inventory/SiteIpt/Wirelless/Wirelless', ['wirelless' => $dataInventory, 'site' => $site, 'role' => $role]);
    }

    public function create()
    {
        return Inertia::render('Inventory/SiteIpt/Wirelless/WirellessCreate', ['inventory_number' => session('inventory_number') ?? null]);
    }
    ...
    public function generateCode(Request $request)
    {
        ...
        $prefix = $dataCompany === 'PPA' ? 'PPAIPTBB' : 'AMMIPTBB';
        ...
        // dd($uniqueString);
        return redirect()->route('wirellessIpt.create')->with([
    ...
    public function generateCodeEdit(Request $request)
    {
        ...
        $uniqueString = $prefix . str_pad(($maxId % 10000) + 1, 3, '0', STR_PAD_LEFT);
        // dd($uniqueString);
        return redirect()->route('wirellessIpt.edit', ['id' => $id])
    ...
    public function detail($id)
    {
        ...
        return Inertia::render('Inventory/SiteIpt/Wirelless/WirellessDetail', [
            'wirelless' => $wirelless,
        ]);
    }
    ...
    public function edit($id)
    {
        ...
        if (str_starts_with($inventoryNumber, 'PPAIPTBB')) {
            $company = 'PPA';
        } elseif (str_starts_with($inventoryNumber, 'AMMIPTBB')) {
            $company = 'AMM';
        }

        return Inertia::render('Inventory/SiteIpt/Wirelless/WirellessEdit', [
            'wirelless' => $wirelless,
