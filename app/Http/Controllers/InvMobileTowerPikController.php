...
class InvMobileTowerPikController extends Controller
{
    public function index()
    {
        $dataInventory = InvMobileTower::where('site', 'PIK')->get();
        // dd($dataInventory);
        $site = 'PIK';
        $role = auth()->user()->role;

        return Inertia::render('Inventory/MobileTower/pik/MobileTower', ['mobileTower' => $dataInventory, 'site' => $site, 'role' => $role]);
    }
    public function create()
    {
        return Inertia::render('Inventory/MobileTower/pik/MobileTowerCreate', ['inventory_number' => session('inventory_number') ?? null]);
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('mobileTowerPik.page');
    }
    ...
    public function edit($id)
    {
        ...
        return Inertia::render('Inventory/MobileTower/pik/MobileTowerEdit', [
            'mtData' => $mtData,
    ...
    public function detail($id)
    {
        ...
        return Inertia::render('Inventory/MobileTower/pik/MobileTowerDetail', [
