...
class InspeksiPrinterBibController extends Controller
{
    public function index(Request $request)
    {
        ...
        return Inertia::render(
            'Inspeksi/SiteBib/Printer/InspeksiPrinterView',
            [
    ...
    public function process($id)
    {
        ...
        // dd($penggunax);
        return Inertia::render('Inspeksi/SiteBib/Printer/InspeksiPrinterCreate', ['dataInspeksi' => $dataInspeksix, 'pengguna' => $penggunax, 'printer' => $printerx]);
    }
    ...
    public function store(Request $request)
    {
        ...
        $maxId = InspeksiPrinter::where('site', "BIB")->where('year', $year)->where('month', $month)->max('pica_number');
        ...
        return redirect()->route('inspeksiPrinterBib.page');
    }
    public function edit($id)
    {
        ...
        return Inertia::render('Inspeksi/SiteBib/Printer/InspeksiPrinterEdit', ['dataInspeksi' => $dataInspeksix, 'pengguna' => $penggunax, 'printer' => $printerx, 'pengguna_selected' => $pengguna_selected]);
    }
    ...
    public function detail($id)
    {
        ...
        return Inertia::render('Inspeksi/SiteBib/Printer/InspeksiPrinterDetail', [
