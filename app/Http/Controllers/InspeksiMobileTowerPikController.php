...
class InspeksiMobileTowerPikController extends Controller
{
    public function index(Request $request)
    {
        ...
        return Inertia::render(
            'Inspeksi/SitePik/MobileTower/InspeksiMobileTowerView',
            [
    ...
    public function process($id)
    {
        ...
        return Inertia::render('Inspeksi/SitePik/MobileTower/InspeksiMobileTowerCreate', ['dataInspeksi' => $dataInspeksix, 'pengguna' => $penggunax, 'mobileTower' => $mobileTowerx, 'dataKategori' => $dataKategori, 'subDataKategori' => $subDataKategori, 'totalItems' => $totalItems,]);
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('inspeksiMobileTowerPik.page');
    }
    ...
    public function detail($id)
    {
        ...
        return Inertia::render('Inspeksi/SitePik/MobileTower/InspeksiMobileTowerDetail', [
    ...
    public function edit($id)
    {
        ...
        return Inertia::render('Inspeksi/SitePik/MobileTower/InspeksiMobileTowerEdit', ['dataInspeksi' => $dataInspeksix, 'pengguna' => $penggunax, 'mobileTower' => $mobileTowerx, 'dataKategori' => $dataKategori, 'subDataKategori' => $subDataKategori, 'totalItems' => $totalItems,]);
    }
