...
class InspeksiComputerSbsController extends Controller
{
    public function index()
    {
        $inspeksi_computer = InspeksiComputer::with('computer.pengguna')->where('site', 'SBS')->get();
        ...
        return Inertia::render(
            'Inspeksi/SiteSbs/Komputer/InspeksiKomputerIndex',
    ...
    public function doInspection($id)
    {
        ...
        $crew = User::where('site', 'SBS')->pluck('name')->map(function ($name) {
            return ['name' => $name];
        })->toArray();
        // return dd($dataInspeksi);
        return Inertia::render('Inspeksi/SiteSbs/Komputer/InspeksiKomputerForm', ['inspeksi' => $dataInspeksi, 'crew' => $crew]);
    }
    ...
    public function store(Request $request)
    {
        ...
        $maxId = InspeksiComputer::where('site', 'SBS')->where('year', $year)->max('pica_number');
        ...
        return redirect()->route('inspeksiKomputerSbs.page');
    }
    ...
    public function edit($id)
    {
        ...
        return Inertia::render('Inspeksi/SiteSbs/Komputer/InspeksiKomputerFormEdit', ['inspeksi' => $dataInspeksi, 'crew' => $crew, 'crew_select' => $crew_select]);
    }
    ...
    public function detail($id)
    {
        ...
        return Inertia::render('Inspeksi/SiteSbs/Komputer/InspeksiKomputerDetail', [
