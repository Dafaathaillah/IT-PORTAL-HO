...
class InvSwitchBibController extends Controller
{
    ...
    public function create()
    {
        ...
        $maxId = InvSwitch::where('site', 'BIB')->orderBy('max_id', 'desc')->first();
        ...
        return Inertia::render('Inventory/SiteBib/Switch/SwitchCreate', ['inventoryNumber' => $uniqueString]);
    }
    ...
    public function edit($swId)
    {
        ...
        return Inertia::render('Inventory/SiteBib/Switch/SwitchEdit', ['switch' => $switch]);
    }
