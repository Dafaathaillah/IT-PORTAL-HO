...
class AduanPikController extends Controller
{
    ...
    public function create()
    {
        ...
        $maxId = Aduan::whereDate('created_at', $currentDate->format('Y-m-d'))->where('site', 'PIK')->orderBy('max_id', 'desc')->first();
        ...
        $crew = User::where('site', 'PIK')->where('ict_group', 'Y')->pluck('name')->map(function ($name) {
            return ['name' => $name];
        })->toArray();

        return Inertia::render('Inventory/SitePik/Aduan/AduanCreate', ['ticket' => $uniqueString, 'crew' => $crew, 'categories' => $categories]);
    }
    ...
    public function progress($id)
    {
        ...
        return Inertia::render('Inventory/SitePik/Aduan/AduanProgress', [
            'aduan' => $aduan,
            'crew' => $crew,
    ...
    public function edit($id)
    {
        ...
        return Inertia::render('Inventory/SitePik/Aduan/AduanEdit', [
            'aduan' => $aduan,
            'crew' => $crew,
    ...
    public function detail($id)
    {
        ...
        return Inertia::render('Inventory/SitePik/Aduan/AduanDetail', [
            'aduan' => $aduan,
        ]);
    }
