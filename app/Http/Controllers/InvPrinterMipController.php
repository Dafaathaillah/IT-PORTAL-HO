...
class InvPrinterMipController extends Controller
{
    public function index()
    {
        ...
        return Inertia::render('Inventory/SiteMip/Printer/Printer', ['printer' => $dataInventory, 'site' => $site, 'role' => $role]);
    }
    ...
    public function create()
    {
        ...
        return Inertia::render('Inventory/SiteMip/Printer/PrinterCreate', ['inventory_number' => session('inventory_number') ?? null, 'department' => $department]);
    }
    ...
    public function generateCode(Request $request)
    {
        ...
        // dd($uniqueString);
        return redirect()->route('printerMip.create')->with([
    ...
    public function generateCodeEdit(Request $request)
    {
        ...
        $uniqueString = $prefix . str_pad(($maxId % 10000) + 1, 3, '0', STR_PAD_LEFT);
        // dd($uniqueString);
        return redirect()->route('printerMip.edit', ['id' => $id])
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('printerMip.page');
    }
    ...
    public function uploadCsv(Request $request)
    {
        try {
            ...
            // dd($duplicates);
            return Redirect::route('printerMip.page')->with([
    ...
    public function detail($id)
    {
        ...
        return Inertia::render('Inventory/SiteMip/Printer/PrinterDetail', [
            'printers' => $printer,
        ]);
    }
    ...
    public function edit($printerId)
    {
        ...
        if (str_starts_with($inventoryNumber, 'PPAMIPPRT')) {
            $company = 'PPA';
        } elseif (str_starts_with($inventoryNumber, 'AMMMIPPRT')) {
            $company = 'AMM';
        }
        ...
        return Inertia::render('Inventory/SiteMip/Printer/PrinterEdit', [
