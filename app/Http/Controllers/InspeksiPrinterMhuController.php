...
class InspeksiPrinterMhuController extends Controller
{
    public function index(Request $request)
    {
        ...
        return Inertia::render(
            'Inspeksi/SiteMhu/Printer/InspeksiPrinterView',
            [
    ...
    public function process($id)
    {
        ...
        $penggunax = User::whereIn('role', ['ict_technician', 'ict_group_leader', 'ict_developer'])->where('site', 'MHU')->pluck('name')->map(function ($name) {
            return ['name' => $name];
        })->toArray();
        // dd($penggunax);
        return Inertia::render('Inspeksi/SiteMhu/Printer/InspeksiPrinterCreate', ['dataInspeksi' => $dataInspeksix, 'pengguna' => $penggunax, 'printer' => $printerx]);
    }
    ...
    public function store(Request $request)
    {
        ...
        $maxId = InspeksiPrinter::where('site', "MHU")->where('year', $year)->where('month', $month)->max('pica_number');
        ...
        return redirect()->route('inspeksiPrinterMhu.page');
    }
    public function edit($id)
    {
        ...
        return Inertia::render('Inspeksi/SiteMhu/Printer/InspeksiPrinterEdit', ['dataInspeksi' => $dataInspeksix, 'pengguna' => $penggunax, 'printer' => $printerx, 'pengguna_selected' => $pengguna_selected]);
    }
    ...
    public function detail($id)
    {
        ...
        return Inertia::render('Inspeksi/SiteMhu/Printer/InspeksiPrinterDetail', [
