...
class InvMobileTowerVibController extends Controller
{
    public function index()
    {
        $dataInventory = InvMobileTower::where('site', 'VIB')->get();
        // dd($dataInventory);
        $site = 'VIB';
        $role = auth()->user()->role;

        return Inertia::render('Inventory/MobileTower/vib/MobileTower', ['mobileTower' => $dataInventory, 'site' => $site, 'role' => $role]);
    }
    public function create()
    {
        return Inertia::render('Inventory/MobileTower/vib/MobileTowerCreate', ['inventory_number' => session('inventory_number') ?? null]);
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('mobileTowerVib.page');
    }
    ...
    public function edit($id)
    {
        ...
        return Inertia::render('Inventory/MobileTower/vib/MobileTowerEdit', [
            'mtData' => $mtData,
    ...
    public function detail($id)
    {
        ...
        return Inertia::render('Inventory/MobileTower/vib/MobileTowerDetail', [
