...
class InvSwitchWARAController extends Controller
{
    public function index()
    {
        ...
        return Inertia::render('Inventory/SiteWARA/Switch/Switch', ['switch' => $dataInventory, 'site' => $site, 'role' => $role]);
    }

    public function create()
    {
        return Inertia::render('Inventory/SiteWARA/Switch/SwitchCreate', ['inventory_number' => session('inventory_number') ?? null]);
    }
    ...
    public function generateCode(Request $request)
    {
        ...
        $prefix = $dataCompany === 'PPA' ? 'PPAADWSW' : 'AMMADWSW';
        ...
        // dd($uniqueString);
        return redirect()->route('switchWARA.create')->with([
    ...
    public function generateCodeEdit(Request $request)
    {
        ...
        $uniqueString = $prefix . str_pad(($maxId % 10000) + 1, 3, '0', STR_PAD_LEFT);
        // dd($uniqueString);
        return redirect()->route('switchWARA.edit', ['swId' => $id])
    ...
    public function uploadCsv(Request $request)
    {
        try {
            ...
            // dd($duplicates);
            return Redirect::route('switchWARA.page')->with([
    ...
    public function edit($swId)
    {
        ...
        return Inertia::render('Inventory/SiteWARA/Switch/SwitchEdit', [
            'switch' => $switch,
    ...
    public function detail($id)
    {
        ...
        return Inertia::render('Inventory/SiteWARA/Switch/SwitchDetail', [
            'switchs' => $switch,
        ]);
    }
