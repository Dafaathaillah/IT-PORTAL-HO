...
class InvSwitchWARAController extends Controller
{
    ...
    public function create()
    {
        ...
        return Inertia::render('Inventory/SiteWARA/Switch/SwitchCreate', ['inventoryNumber' => $uniqueString]);
    }
    ...
    public function uploadCsv(Request $request)
    {
        try {
            ...
            // return redirect()->route('switch.page')->with('message', 'Data berhasil ditamWARAhkan');
            return redirect()->route('switchWARA.page');
        } catch (\Exception $ex) {
            Log::info($ex);
    ...
    public function edit($swId)
    {
        ...
        return Inertia::render('Inventory/SiteWARA/Switch/SwitchEdit', ['switch' => $switch]);
    }
