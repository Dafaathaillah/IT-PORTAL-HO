...
class InvMobileTowerIptController extends Controller
{
    public function index()
    {
        $dataInventory = InvMobileTower::where('site', 'IPT')->get();
        // dd($dataInventory);
        $site = 'IPT';
        $role = auth()->user()->role;

        return Inertia::render('Inventory/MobileTower/ipt/MobileTower', ['mobileTower' => $dataInventory, 'site' => $site, 'role' => $role]);
    }
    public function create()
    {
        return Inertia::render('Inventory/MobileTower/ipt/MobileTowerCreate', ['inventory_number' => session('inventory_number') ?? null]);
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('mobileTowerIpt.page');
    }
    ...
    public function edit($id)
    {
        ...
        return Inertia::render('Inventory/MobileTower/ipt/MobileTowerEdit', [
            'mtData' => $mtData,
    ...
    public function detail($id)
    {
        ...
        return Inertia::render('Inventory/MobileTower/ipt/MobileTowerDetail', [
