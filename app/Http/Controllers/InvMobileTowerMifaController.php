...
class InvMobileTowerMifaController extends Controller
{
    ...
    {
        $dataInventory = InvMobileTower::orderBy('inventory_number', 'desc')->where('site', 'MIFA')->get();
        // dd($dataInventory);
        $site = 'MIFA';
        $role = auth()->user()->role;
    ...
    public function create()
    {
        ...
        return Inertia::render('Inventory/MobileTower/mifa/MobileTowerCreate', ['inventoryNumber' => $site . '-MT-' . $nextNumber]);
    }
