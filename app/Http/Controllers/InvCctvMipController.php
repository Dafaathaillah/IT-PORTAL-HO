...
class InvCctvMipController extends Controller
{
    ...
    public function create()
    {
        ...
        $maxId = InvCctv::where('site', 'MIP')->orderBy('max_id', 'desc')->first();
        // dd($maxId->cctv_code);
        ...
        $uniqueString = 'PPAMIPCCTV' . str_pad(($maxId % 10000) + 1, 3, '0', STR_PAD_LEFT);
        ...
        return Inertia::render('Inventory/SiteMip/Cctv/CctvCreate', ['inventoryNumber' => $uniqueString, 'switch' => $switch]);
    }
