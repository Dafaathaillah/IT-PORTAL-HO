...
class InvMobileTowerSksController extends Controller
{
    ...
    {
        $dataInventory = InvMobileTower::where('site', 'SKS')->get();
        // dd($dataInventory);
        $site = 'SKS';
        $role = auth()->user()->role;
    ...
    {
        return Inertia::render('Inventory/MobileTower/sks/MobileTowerCreate', ['inventory_number' => session('inventory_number') ?? null]);
    }
