...
class InvMobileTowerSksController extends Controller
{
    public function index()
    {
        $dataInventory = InvMobileTower::orderBy('inventory_number', 'desc')->where('site', 'SKS')->get();
        // dd($dataInventory);
        $site = 'SKS';
        $role = auth()->user()->role;

        return Inertia::render('Inventory/MobileTower/sks/MobileTower', ['mobileTower' => $dataInventory, 'site' => $site, 'role' => $role]);
    }
    public function create()
    {
        ...
        return Inertia::render('Inventory/MobileTower/sks/MobileTowerCreate', ['inventoryNumber' => $site . '-MT-' . $nextNumber]);
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('mobileTowerSks.page');
    }
    ...
    public function edit($id)
    {
        ...
        return Inertia::render('Inventory/MobileTower/sks/MobileTowerEdit', [
            'mtData' => $mtData,
    ...
    public function detail($id)
    {
        ...
        return Inertia::render('Inventory/MobileTower/sks/MobileTowerDetail', [
