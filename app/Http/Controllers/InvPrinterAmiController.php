...
class InvPrinterAmiController extends Controller
{
    public function index()
    {
        $dataInventory = InvPrinter::where('site', 'AMI')->orderBy('printer_code', 'desc')->get();
        $site = auth()->user()->site;
        $role = auth()->user()->role;

        return Inertia::render('Inventory/SiteAmi/Printer/Printer', ['printer' => $dataInventory, 'site' => $site, 'role' => $role]);
    }
    ...
    public function create()
    {
        ...
        return Inertia::render('Inventory/SiteAmi/Printer/PrinterCreate', ['inventory_number' => session('inventory_number') ?? null, 'department' => $department]);
    }
    ...
    public function generateCode(Request $request)
    {
        ...
        // dd($uniqueString);
        return redirect()->route('printerAmi.create')->with([
    ...
    public function generateCodeEdit(Request $request)
    {
        ...
        $uniqueString = $prefix . str_pad(($maxId % 10000) + 1, 3, '0', STR_PAD_LEFT);
        // dd($uniqueString);
        return redirect()->route('printerAmi.edit', ['id' => $id])
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('printerAmi.page');
    }
    ...
    public function uploadCsv(Request $request)
    {
        try {
            ...
            // dd($duplicates);
            return Redirect::route('printerAmi.page')->with([
    ...
    public function detail($id)
    {
        ...
        return Inertia::render('Inventory/SiteAmi/Printer/PrinterDetail', [
            'printers' => $printer,
        ]);
    }
    ...
    public function edit($printerId)
    {
        ...
        if (str_starts_with($inventoryNumber, 'PPAAMIPRT')) {
            $company = 'PPA';
        } elseif (str_starts_with($inventoryNumber, 'AMMAMIPRT')) {
            $company = 'AMM';
        }
        ...
        return Inertia::render(
            'Inventory/SiteAmi/Printer/PrinterEdit',
            [
