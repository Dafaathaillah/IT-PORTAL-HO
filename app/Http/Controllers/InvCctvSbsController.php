...
class InvCctvSbsController extends Controller
{
    ...
    public function create()
    {
        ...
        $maxId = InvCctv::where('site', 'SBS')->orderBy('max_id', 'desc')->first();
        // dd($maxId->cctv_code);
        ...
        $uniqueString = 'PPASBSCCTV' . str_pad(($maxId % 10000) + 1, 3, '0', STR_PAD_LEFT);
        ...
        return Inertia::render('Inventory/SiteSbs/Cctv/CctvCreate', ['inventoryNumber' => $uniqueString, 'switch' => $switch]);
    }
