...
class InspeksiComputerMifaController extends Controller
{
    public function index()
    {
        $inspeksi_computer = InspeksiComputer::with('computer.pengguna')->where('site', 'MIFA')->get();
    ...
    public function doInspection($id)
    {
        ...
        return Inertia::render('Inspeksi/SiteMifa/Komputer/InspeksiKomputerForm', ['inspeksi' => $dataInspeksi, 'crew' => $crew]);
    }
    ...
    public function store(Request $request)
    {
        ...
        $maxId = InspeksiComputer::where('site', 'MIFA')->where('year', $year)->max('pica_number');
        ...
        return redirect()->route('inspeksiKomputerMifa.page');
    }
    ...
    public function detail($id)
    {
        ...
        return Inertia::render('Inspeksi/SiteMifa/Komputer/InspeksiKomputerDetail', [
