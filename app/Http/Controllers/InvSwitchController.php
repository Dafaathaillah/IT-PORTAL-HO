...
class InvSwitchController extends Controller
{
    ...
    {
        return Inertia::render('Inventory/Switch/SwitchCreate', ['inventory_number' => session('inventory_number') ?? null]);
    }
    ...
    public function generateCode(Request $request)
    {
        ...
        $prefix = $dataCompany === 'PPA' ? 'PPAHOSW' : 'AMMHOSW';
        ...
        // dd($uniqueString);
        return redirect()->route('switch.create')->with([
    ...
    public function generateCodeEdit(Request $request)
    {
        ...
        $uniqueString = $prefix . str_pad(($maxId % 10000) + 1, 3, '0', STR_PAD_LEFT);
        // dd($uniqueString);
        return redirect()->route('switch.edit', ['swId' => $id])
    ...
    public function uploadCsv(Request $request)
    {
        try {
            ...
            // dd($duplicates);
            return Redirect::route('switch.page')->with([
    ...
    public function edit($swId)
    {
        ...
        return Inertia::render('Inventory/Switch/SwitchEdit', [
            'switch' => $switch,
