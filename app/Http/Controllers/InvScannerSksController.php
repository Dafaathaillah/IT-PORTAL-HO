...
class InvScannerSksController extends Controller
{
    ...
    public function create()
    {
        ...
        $maxId = InvScanner::where('site', 'SKS')->orderBy('max_id', 'desc')->first();
        ...
        $uniqueString = 'PPASKSSCN' . str_pad(($maxId % 10000) + 1, 3, '0', STR_PAD_LEFT);
        ...
        return Inertia::render('Inventory/SiteSks/Scanner/ScannerCreate', ['scanner_code' => $uniqueString, 'department' => $department]);
    }
    ...
    public function edit($id)
    {
        ...
        return Inertia::render('Inventory/SiteSks/Scanner/ScannerEdit', ['scanner' => $scanner, 'department' => $department, 'department_select' => $department_select]);
    }
