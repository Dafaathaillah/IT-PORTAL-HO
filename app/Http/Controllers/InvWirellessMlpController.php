...
class InvWirellessMlpController extends Controller
{
    public function index()
    {
        ...
        return Inertia::render('Inventory/SiteMlp/Wirelless/Wirelless', ['wirelless' => $dataInventory, 'site' => $site, 'role' => $role]);
    }

    public function create()
    {
        return Inertia::render('Inventory/SiteMlp/Wirelless/WirellessCreate', ['inventory_number' => session('inventory_number') ?? null]);
    }
    ...
    public function generateCode(Request $request)
    {
        ...
        // dd($uniqueString);
        return redirect()->route('wirellessMlp.create')->with([
    ...
    public function generateCodeEdit(Request $request)
    {
        ...
        $uniqueString = $prefix . str_pad(($maxId % 10000) + 1, 3, '0', STR_PAD_LEFT);
        // dd($uniqueString);
        return redirect()->route('wirellessMlp.edit', ['id' => $id])
    ...
    public function uploadCsv(Request $request)
    {
        try {
            ...
            // dd($duplicates);
            return Redirect::route('wirellessMlp.page')->with([
    ...
    public function detail($id)
    {
        ...
        return Inertia::render('Inventory/SiteMlp/Wirelless/WirellessDetail', [
            'wirelless' => $wirelless,
        ]);
    }
    ...
    public function edit($id)
    {
        ...
        if (str_starts_with($inventoryNumber, 'PPAMLPBB')) {
            $company = 'PPA';
        } elseif (str_starts_with($inventoryNumber, 'AMMMLPBB')) {
            $company = 'AMM';
        }

        return Inertia::render('Inventory/SiteMlp/Wirelless/WirellessEdit', [
            'wirelless' => $wirelless,
