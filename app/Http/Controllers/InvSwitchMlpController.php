...
class InvSwitchMlpController extends Controller
{
    ...
    public function create()
    {
        ...
        $maxId = InvSwitch::where('site', 'MLP')->orderBy('max_id', 'desc')->first();
        ...
        $uniqueString = 'PPAMLPSW' . str_pad(($maxId % 10000) + 1, 3, '0', STR_PAD_LEFT);

        $request['inventory_number'] = $uniqueString;
        // end generate code

        return Inertia::render('Inventory/SiteMlp/Switch/SwitchCreate', ['inventoryNumber' => $uniqueString]);
    }
    ...
    public function edit($swId)
    {
        ...
        return Inertia::render('Inventory/SiteMlp/Switch/SwitchEdit', ['switch' => $switch]);
    }
