...
class AduanAmiController extends Controller
{
    ...
    public function create()
    {
        ...
        $maxId = Aduan::whereDate('created_at', $currentDate->format('Y-m-d'))->where('site', 'AMI')->orderBy('max_id', 'desc')->first();
        ...
        return Inertia::render('Inventory/SiteAmi/Aduan/AduanCreate', ['ticket' => $uniqueString, 'crew' => $crew, 'categories' => $categories]);
    }
    ...
    public function progress($id)
    {
        ...
        return Inertia::render('Inventory/SiteAmi/Aduan/AduanProgress', [
            'aduan' => $aduan,
            'crew' => $crew,
    ...
    public function detail($id)
    {
        ...
        return Inertia::render('Inventory/SiteAmi/Aduan/AduanDetail', [
            'aduan' => $aduan,
        ]);
    }
