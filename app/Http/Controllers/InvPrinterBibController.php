...
class InvPrinterBibController extends Controller
{
    ...
    public function create()
    {
        ...
        $maxId = InvPrinter::where('site', 'BIB')->orderBy('max_id', 'desc')->first();
        ...
        return Inertia::render('Inventory/SiteBib/Printer/PrinterCreate', ['printer_code' => $uniqueString, 'department' => $department]);
    }
    ...
    public function edit($printerId)
    {
        ...
        return Inertia::render('Inventory/SiteBib/Printer/PrinterEdit', ['printer' => $printer, 'department' => $department, 'department_select' => $department_select]);
    }
