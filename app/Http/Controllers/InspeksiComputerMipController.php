...
class InspeksiComputerMipController extends Controller
{
    ...
    public function doInspection($id)
    {
        ...
        $crew = User::where('site', 'MIP')->pluck('name')->map(function ($name) {
            return ['name' => $name];
        })->toArray();
        // return dd($dataInspeksi);
        return Inertia::render('Inspeksi/SiteMip/Komputer/InspeksiKomputerForm', ['inspeksi' => $dataInspeksi, 'crew' => $crew]);
    }
    ...
    public function store(Request $request)
    {
        ...
        $maxId = InspeksiComputer::where('site', 'MIP')->where('year', $year)->max('pica_number');
        ...
        return redirect()->route('inspeksiKomputerMip.page');
    }
    ...
    public function edit($id)
    {
        ...
        return Inertia::render('Inspeksi/SiteMip/Komputer/InspeksiKomputerFormEdit', ['inspeksi' => $dataInspeksi, 'crew' => $crew, 'crew_select' => $crew_select]);
    }
    ...
    public function detail($id)
    {
        ...
        return Inertia::render('Inspeksi/SiteMip/Komputer/InspeksiKomputerDetail', [
