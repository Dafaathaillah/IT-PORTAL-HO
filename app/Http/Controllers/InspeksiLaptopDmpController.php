...
class InspeksiLaptopDmpController extends Controller
{
    public function index(Request $request)
    {
        ...
        $inspeksi_laptop = InspeksiLaptop::with('inventory.pengguna')->where('site', 'DMP')->where('year', $yearNow)->get();
        ...
        return Inertia::render(
            'Inspeksi/SiteDmp/Laptop/InspeksiLaptopView',
    ...
    public function process($id)
    {
        ...
        $penggunax = User::whereIn('role', ['ict_technician', 'ict_group_leader'])->where('site', 'DMP')->pluck('name')->map(function ($name) {
            return ['name' => $name];
        })->toArray();

        return Inertia::render('Inspeksi/SiteDmp/Laptop/InspeksiLaptopCreate', ['dataInspeksi' => $dataInspeksix, 'pengguna' => $penggunax, 'laptop' => $laptopx]);
    }
    ...
    public function store(Request $request)
    {
        ...
        $maxId = InspeksiLaptop::where('site', "DMP")->where('year', $year)->max('pica_number');
        ...
        return redirect()->route('inspeksiLaptopDmp.page');
    }
    ...
    public function edit($id)
    {
        ...
        return Inertia::render('Inspeksi/SiteDmp/Laptop/InspeksiLaptopEdit', ['dataInspeksi' => $dataInspeksix, 'pengguna' => $penggunax, 'laptop' => $laptopx, 'pengguna_selected' => $pengguna_selected]);
    }
    ...
    public function approval(Request $request)
    {
        ...
        $site = 'DMP'; // fallback jika site tidak tersedia
    ...
    public function detail($id)
    {
        ...
        return Inertia::render('Inspeksi/SiteDmp/Laptop/InspeksiLaptopDetail', [
