...
class InspeksiComputerAmiController extends Controller
{
    public function index()
    {
        $inspeksi_computer = InspeksiComputer::with('computer.pengguna')->where('site', 'AMI')->get();
        ...
        return Inertia::render(
            'Inspeksi/SiteAmi/Komputer/InspeksiKomputerIndex',
    ...
    public function doInspection($id)
    {
        ...
        return Inertia::render('Inspeksi/SiteAmi/Komputer/InspeksiKomputerForm', ['inspeksi' => $dataInspeksi, 'crew' => $crew]);
    }
    ...
    public function store(Request $request)
    {
        ...
        $maxId = InspeksiComputer::where('site', 'AMI')->where('year', $year)->max('pica_number');
        ...
        return redirect()->route('inspeksiKomputerAmi.page');
    }
    ...
    public function edit($id)
    {
        ...
        return Inertia::render('Inspeksi/SiteAmi/Komputer/InspeksiKomputerFormEdit', ['inspeksi' => $dataInspeksi, 'crew' => $crew, 'crew_select' => $crew_select]);
    }
    ...
    public function detail($id)
    {
        ...
        return Inertia::render('Inspeksi/SiteAmi/Komputer/InspeksiKomputerDetail', [
