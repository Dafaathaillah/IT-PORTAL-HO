...
class InvComputerSbsController extends Controller
{
    public function index()
    {
        ...
        return Inertia::render('Inventory/SiteSbs/Komputer/Komputer', ['komputer' => $dataInventory, 'site' => $site, 'role' => $role, 'department' => $department]);
    }
    ...
    public function create()
    {
        ...
        $pengguna = UserAll::where('site', 'SBS')->select('username', 'nrp', 'department')->get()->map(function ($item) {
            return [
                'nrp' => $item->nrp,
                'name' => $item->username,
    ...
    public function store(Request $request)
    {
        ...
        if ($existingDataSn) {
            ...
            return Redirect::route('komputerSbs.page')->with([
        ...
        $aduan_get_data_user = UserAll::where('site', 'SBS')->where('nrp', $params['user_alls_id'])->first();
    ...
    public function edit($id)
    {
        ...
        return Inertia::render('Inventory/SiteSbs/Komputer/KomputerEdit', [
            'komputer' => $komputer,
            'model' => $model,
            'processor' => $processor,
            'hdd' => $hdd,
    ...
    public function detail($id)
    {
        ...
        return Inertia::render('Inventory/SiteSbs/Komputer/KomputerDetail', [
            'komputer' => $komputer,
            'aduan' => $aduan,
        ]);
    }
