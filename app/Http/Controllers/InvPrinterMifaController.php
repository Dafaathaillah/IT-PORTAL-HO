...
class InvPrinterMifaController extends Controller
{
    ...
    public function create()
    {
        ...
        $maxId = InvPrinter::where('site', 'MIFA')->orderBy('max_id', 'desc')->first();
        ...
        return Inertia::render('Inventory/SiteMifa/Printer/PrinterCreate', ['printer_code' => $uniqueString, 'department' => $department]);
    }
