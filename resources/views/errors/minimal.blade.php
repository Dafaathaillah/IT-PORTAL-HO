...
<head>
  ...
  <body class="m-0 font-sans text-base antialiased font-normal text-left bg-white leading-default dark:bg-slate-900 text-slate-500 dark:text-white/80">
    <main class="mt-0 transition-all duration-200 ease-in-out">
        <div class="pb-0 pt-0 h-full min-h-screen items-start p-0 relative overflow-hidden flex bg-cover bg-center" style="background-image: url('{{ asset('../assets/img/illustrations/404.svg') }}');">
          <div class="container">
