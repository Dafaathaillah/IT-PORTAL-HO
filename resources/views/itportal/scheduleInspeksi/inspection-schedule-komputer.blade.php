...
<head>
    <meta charset="UTF-8">
    <title>Jadwal Inspeksi Komputer – {{ $triwulan }}</title>
...
<body>
    <div class="container">
        ...
        {{-- ---------- TITLE & META ---------- --}}
        <div class="title">FORM JADWAL INSPEKSI KOMPUTER - {{ strtoupper($triwulan) }}</div>
        ...
        <table>
            <thead>
                <tr>
                    ...
                    <th style="width: 25%;">Computer Code</th>
