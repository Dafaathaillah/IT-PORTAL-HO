    ...
    <div class="container">
        <div class="form-container">
            ...
            <div class="section">
                ...
                @php
                    $checklistResults = json_decode($inspection->checklist_results_list ?? '{}', true);
                @endphp
                ...
                <table>
                    @php
                        ...
                        $findings = json_decode($inspection->findings ?? '[]', true) ?? [];
                        $actions = json_decode($inspection->findings_action ?? '[]', true) ?? [];
                    @endphp
                    ...
                    <tr>
                        <th>Kelayakan</th>
                        <td>{{ $inspection->worthiness ?? '-'  }}</td>
                    </tr>
                    <tr>
                        <th>PIC</th>
                        <td>{{ $inspection->pic ?? '-'  }}</td>
                    </tr>
                    <tr>
                        <th>Due Date</th>
                        <td>
