...
const deleteData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            form.delete(route("aduanBib.delete", { id: id }), {
                onSuccess: () => {
                    Swal.fire({
                        title: "Deleted!",
...
const editData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            form.get(route("aduanBib.edit", { id: id }));
        }
    });
};

const progressAduan = (id) => {
    form.get(route("aduanBib.progress", { id: id }));
};
...
const acceptAduan = (id) => {
    Swal.fire({
      ...
      `,
        ...
        if (result.isConfirmed) {
            axios
                .post(route("aduanBib.accept", { id: id }))
                .then((response) => {
                    Swal.fire({
                        icon: "success",
                        title: "Berhasil!",
...
onMounted(() => {
    ...
    if (!sessionStorage.getItem("guideShownBib")) {
        Swal.fire({
            title: "Panduan",
            html: `
      ...
      `,
            ...
            sessionStorage.setItem("guideShownBib", "true");
        });
    }
});

const detailData = (id) => {
    form.get(route("aduanBib.detail", { id: id }));
};
...
const submitCsv = () => {
    ...
    Inertia.post(route("aduanBib.import"), formData, {
        forceFormData: true,
        onSuccess: () => {
