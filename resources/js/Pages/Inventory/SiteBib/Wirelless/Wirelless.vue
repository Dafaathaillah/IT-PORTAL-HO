...
const detailData = (id) => {
    form.get(route("wirellessBib.detail", { id: id }));
};
...
const deleteData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            form.delete(route("wirellessBib.delete", { id: id }), {
                onSuccess: () => {
                    Swal.fire({
                        title: "Deleted!",
...
const editData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            form.get(route("wirellessBib.edit", { id: id }));
        }
    });
};
...
const submitCsv = () => {
    ...
    formx.post(route("wirellessBib.import"), {
        onSuccess: () => {
                ...
                <div class="flex flex-wrap -mx-3">
                    ...
                    <div class="flex-none w-full max-w-full px-3">
                        ...
                        >
                            ...
                            >
                                <Link
                                    :href="route('wirellessBib.create')"
