...
const deleteData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            form.delete(route("scannerBib.delete", { id: id }), {
                onSuccess: () => {
                    Swal.fire({
                        title: "Deleted!",
...
const editData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            form.get(route("scannerBib.edit", { id: id }));
        }
    });
};

const detailData = (id) => {
    form.get(route("scannerBib.detail", { id: id }));
};
...
const submitCsv = () => {
    ...
    formx.post(route("scannerBib.import"), {
        onSuccess: () => {
