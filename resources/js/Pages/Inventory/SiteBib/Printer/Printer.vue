...
const deleteData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            form.delete(route("printerBib.delete", { id: id }), {
                onSuccess: () => {
                    Swal.fire({
                        title: "Deleted!",
...
const editData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            form.get(route("printerBib.edit", { id: id }));
        }
    });
};

const detailData = (id) => {
    form.get(route("printerBib.detail", { id: id }));
};
...
const submitCsv = () => {
    ...
    formx.post(route("printerBib.import"), {
        onSuccess: () => {
