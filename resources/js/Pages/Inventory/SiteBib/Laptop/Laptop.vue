...
const deleteData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            form.delete(route("laptopBib.delete", { id: id }), {
                onSuccess: () => {
                    Swal.fire({
                        title: "Deleted!",
...
const editData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            form.get(route("laptopBib.edit", { id: id }));
        }
    });
};

const detailData = (id) => {
    form.get(route("laptopBib.detail", { id: id }));
};
                                                ...
                                                <tbody>
                                                    ...
                                                    >
                                                        ...
                                                        >
                                                            ...
                                                            >
                                                                {{
                                                                    laptops.pengguna?.username || 'No User'
                                                                }}
                                                            </p>
                                                        </td>
                                                        <td
                                                        ...
                                                        >
                                                            ...
                                                            >
                                                                {{
                                                                    laptops.pengguna?.department || 'Tidak Ada Department'
                                                                }}
                                                            </p>
                                                        </td>
                                                        <td
                                                        ...
                                                        >
                                                            ...
                                                            >
                                                                {{
                                                                    laptops.pengguna?.position || 'Posisi Tidak Ditemukan'
                                                                }}
                                                            </p>
                                                        </td>
                                                        <td
