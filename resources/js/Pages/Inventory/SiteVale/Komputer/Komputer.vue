...
const deleteData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            form.delete(route("komputerVale.delete", { id: id }), {
                onSuccess: () => {
                    Swal.fire({
                        title: "Deleted!",
...
const editData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            form.get(route("komputerVale.edit", { id: id }));
        }
    });
};

const detailData = (id) => {
    form.get(route("komputerVale.detail", { id: id }));
};
...
const submitCsv = () => {
    ...
    formx.post(route("komputerVale.import"), {
        onSuccess: () => {
