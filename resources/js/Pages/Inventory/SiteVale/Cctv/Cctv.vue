...
const deleteData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            form.delete(route("cctvVale.delete", { id: id }), {
                onSuccess: () => {
                    Swal.fire({
                        title: "Deleted!",
...
const editData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            form.get(route("cctvVale.edit", { id: id }));
        }
    });
};

const detailData = (id) => {
    form.get(route("cctvVale.detail", { id: id }));
};
...
const submitCsv = () => {
    ...
    formx.post(route("cctvVale.import"), {
        onSuccess: () => {
