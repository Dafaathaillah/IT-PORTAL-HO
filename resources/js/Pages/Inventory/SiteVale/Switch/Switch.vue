...
const deleteData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            form.delete(route("switchVale.delete", { id: id }), {
                onSuccess: () => {
                    Swal.fire({
                        title: "Deleted!",
...
const editData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            form.get(route("switchVale.edit", { id: id }));
        }
    });
};

const detailData = (id) => {
    form.get(route("switchVale.detail", { id: id }));
};
...
const submitCsv = () => {
    ...
    formx.post(route("switchVale.import"), {
        onSuccess: () => {
