...
const deleteData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            form.delete(route("scannerVale.delete", { id: id }), {
                onSuccess: () => {
                    Swal.fire({
                        title: "Deleted!",
...
const editData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            form.get(route("scannerVale.edit", { id: id }));
        }
    });
};

const detailData = (id) => {
    form.get(route("scannerVale.detail", { id: id }));
};
...
const submitCsv = () => {
    ...
    formx.post(route("scannerVale.import"), {
        onSuccess: () => {
