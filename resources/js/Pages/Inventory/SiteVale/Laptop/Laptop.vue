...
const deleteData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            form.delete(route("laptopVale.delete", { id: id }), {
                onSuccess: () => {
                    Swal.fire({
                        title: "Deleted!",
...
const editData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            form.get(route("laptopVale.edit", { id: id }));
        }
    });
};

const detailData = (id) => {
    form.get(route("laptopVale.detail", { id: id }));
};
...
const submitCsv = () => {
    ...
    formx.post(route("laptopVale.import"), {
        onSuccess: () => {
