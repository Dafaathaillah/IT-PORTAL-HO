...
const deleteData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            form.delete(route("laptopMifa.delete", { id: id }), {
                onSuccess: () => {
                    Swal.fire({
                        title: "Deleted!",
...
const editData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            form.get(route("laptopMifa.edit", { id: id }));
        }
    });
};

const detailData = (id) => {
    form.get(route("laptopMifa.detail", { id: id }));
};
...
const submitCsv = () => {
    ...
    formx.post(route("laptopMifa.import"), {
        onSuccess: () => {
