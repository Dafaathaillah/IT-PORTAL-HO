...
const deleteData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            form.delete(route("printerMifa.delete", { id: id }), {
                onSuccess: () => {
                    Swal.fire({
                        title: "Deleted!",
...
const editData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            form.get(route("printerMifa.edit", { id: id }));
        }
    });
};

const detailData = (id) => {
    form.get(route("printerMifa.detail", { id: id }));
};
...
const submitCsv = () => {
    ...
    formx.post(route("printerMifa.import"), {
        onSuccess: () => {
