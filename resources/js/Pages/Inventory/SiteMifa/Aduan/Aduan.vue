...
const deleteData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            form.delete(route("aduanMifa.delete", { id: id }), {
                onSuccess: () => {
                    Swal.fire({
                        title: "Deleted!",
...
const editData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            form.get(route("aduanMifa.edit", { id: id }));
        }
    });
};
...
const submitCsv = () => {
    ...
    Inertia.post(route("aduanMifa.import"), formData, {
        forceFormData: true,
        onSuccess: () => {
...
function updateUrgency(id, value) {
    ...
    axios
        .post(route("aduanMifa.updateUrgency"), {
            id: id,
            urgency: value,
        })
        .then((res) => {
