...
const deleteData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            form.delete(route("cctvMifa.delete", { id: id }), {
                onSuccess: () => {
                    Swal.fire({
                        title: "Deleted!",
...
const editData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            form.get(route("cctvMifa.edit", { id: id }));
        }
    });
};

const detailData = (id) => {
    form.get(route("cctvMifa.detail", { id: id }));
};
...
const submitCsv = () => {
    ...
    formx.post(route("cctvMifa.import"), {
        onSuccess: () => {
