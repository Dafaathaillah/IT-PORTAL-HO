...
const deleteData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            form.delete(route("switchMifa.delete", { id: id }), {
                onSuccess: () => {
                    Swal.fire({
                        title: "Deleted!",
...
const editData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            form.get(route("switchMifa.edit", { id: id }));
        }
    });
};

const detailData = (id) => {
    form.get(route("switchMifa.detail", { id: id }));
};
...
const submitCsv = () => {
    ...
    formx.post(route("switchMifa.import"), {
        onSuccess: () => {
