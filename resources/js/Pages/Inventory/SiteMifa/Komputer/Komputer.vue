...
const deleteData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            form.delete(route("komputerMifa.delete", { id: id }), {
                onSuccess: () => {
                    Swal.fire({
                        title: "Deleted!",
...
const editData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            form.get(route("komputerMifa.edit", { id: id }));
        }
    });
};

const detailData = (id) => {
    form.get(route("komputerMifa.detail", { id: id }));
};
...
const submitCsv = () => {
    ...
    formx.post(route("komputerMifa.import"), {
        onSuccess: () => {
