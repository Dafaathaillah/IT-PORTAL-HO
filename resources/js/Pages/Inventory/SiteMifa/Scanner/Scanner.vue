...
const deleteData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            form.delete(route("scannerMifa.delete", { id: id }), {
                onSuccess: () => {
                    Swal.fire({
                        title: "Deleted!",
...
const editData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            form.get(route("scannerMifa.edit", { id: id }));
        }
    });
};

const detailData = (id) => {
    form.get(route("scannerMifa.detail", { id: id }));
};
...
const submitCsv = () => {
    ...
    formx.post(route("scannerMifa.import"), {
        onSuccess: () => {
