...
const detailData = (id) => {
    form.get(route("wirellessBa.detail", { id: id }));
};
...
const deleteData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            form.delete(route("wirellessBa.delete", { id: id }), {
                onSuccess: () => {
                    Swal.fire({
                        title: "Deleted!",
...
const editData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            form.get(route("wirellessBa.edit", { id: id }));
        }
    });
};
...
const submitCsv = () => {
    ...
    formx.post(route("wirellessBa.import"), {
        onSuccess: () => {
