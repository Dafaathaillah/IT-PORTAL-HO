...
const deleteData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            form.delete(route("cctvBa.delete", { id: id }), {
                onSuccess: () => {
                    Swal.fire({
                        title: "Deleted!",
...
const editData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            form.get(route("cctvBa.edit", { id: id }));
        }
    });
};

const detailData = (id) => {
    form.get(route("cctvBa.detail", { id: id }));
};
...
const submitCsv = () => {
    ...
    formx.post(route("cctvBa.import"), {
        onSuccess: () => {
