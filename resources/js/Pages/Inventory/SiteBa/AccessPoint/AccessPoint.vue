...
const editData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            form.get(route("accessPointBa.edit", { id: id }));
        }
    });
};

const detailData = (id) => {
    form.get(route("accessPointBa.detail", { id: id }));
};
...
const submitCsv = () => {
    ...
    formx.post(route("accessPointBa.import"), {
        onSuccess: () => {
            Swal.fire({
                title: "Success!",
                ...
                <div class="flex flex-wrap -mx-3">
                    ...
                    <div class="flex-none w-full max-w-full px-3">
                        ...
                        >
                            ...
                            >
                                <Link
                                    :href="route('accessPointBa.create')"
