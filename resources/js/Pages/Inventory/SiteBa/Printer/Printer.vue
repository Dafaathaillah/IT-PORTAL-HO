...
const deleteData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            form.delete(route("printerBa.delete", { id: id }), {
                onSuccess: () => {
                    Swal.fire({
                        title: "Deleted!",
...
const editData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            form.get(route("printerBa.edit", { id: id }));
        }
    });
};

const detailData = (id) => {
    form.get(route("printerBa.detail", { id: id }));
};
...
const submitCsv = () => {
    ...
    formx.post(route("printerBa.import"), {
        onSuccess: () => {
