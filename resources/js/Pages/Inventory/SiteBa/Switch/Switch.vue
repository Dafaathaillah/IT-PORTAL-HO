...
const deleteData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            form.delete(route("switchBa.delete", { id: id }), {
                onSuccess: () => {
                    Swal.fire({
                        title: "Deleted!",
...
const editData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            form.get(route("switchBa.edit", { id: id }));
        }
    });
};

const detailData = (id) => {
    form.get(route("switchBa.detail", { id: id }));
};
...
const submitCsv = () => {
    ...
    formx.post(route("switchBa.import"), {
        onSuccess: () => {
