...
const deleteData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            form.delete(route("komputerSbs.delete", { id: id }), {
                onSuccess: () => {
                    Swal.fire({
                        title: "Deleted!",
...
const editData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            form.get(route("komputerSbs.edit", { id: id }));
        }
    });
};

const detailData = (id) => {
    form.get(route("komputerSbs.detail", { id: id }));
};
...
const submitCsv = () => {
    ...
    formx.post(route("komputerSbs.import"), {
        onSuccess: () => {
