...
const deleteData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            form.delete(route("laptopSbs.delete", { id: id }), {
                onSuccess: () => {
                    Swal.fire({
                        title: "Deleted!",
...
const editData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            form.get(route("laptopSbs.edit", { id: id }));
        }
    });
};

const detailData = (id) => {
    form.get(route("laptopSbs.detail", { id: id }));
};
...
const submitCsv = () => {
    ...
    formx.post(route("laptopSbs.import"), {
        onSuccess: () => {
