...
const deleteData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            form.delete(route("scannerSbs.delete", { id: id }), {
                onSuccess: () => {
                    Swal.fire({
                        title: "Deleted!",
...
const editData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            form.get(route("scannerSbs.edit", { id: id }));
        }
    });
};

const detailData = (id) => {
    form.get(route("scannerSbs.detail", { id: id }));
};
...
const submitCsv = () => {
    ...
    formx.post(route("scannerSbs.import"), {
        onSuccess: () => {
