...
const deleteData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            form.delete(route("printerSbs.delete", { id: id }), {
                onSuccess: () => {
                    Swal.fire({
                        title: "Deleted!",
...
const editData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            form.get(route("printerSbs.edit", { id: id }));
        }
    });
};

const detailData = (id) => {
    form.get(route("printerSbs.detail", { id: id }));
};
...
const submitCsv = () => {
    ...
    formx.post(route("printerSbs.import"), {
        onSuccess: () => {
