...
const deleteData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            form.delete(route("switchSbs.delete", { id: id }), {
                onSuccess: () => {
                    Swal.fire({
                        title: "Deleted!",
...
const editData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            form.get(route("switchSbs.edit", { id: id }));
        }
    });
};

const detailData = (id) => {
    form.get(route("switchSbs.detail", { id: id }));
};
...
const submitCsv = () => {
    ...
    formx.post(route("switchSbs.import"), {
        onSuccess: () => {
