...
const deleteData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            form.delete(route("aduanMlp.delete", { id: id }), {
                onSuccess: () => {
                    Swal.fire({
                        title: "Deleted!",
...
const editData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            form.get(route("aduanMlp.edit", { id: id }));
        }
    });
};

const progressAduan = (id) => {
    form.get(route("aduanMlp.progress", { id: id }));
};

const detailData = (id) => {
    form.get(route("aduanMlp.detail", { id: id }));
};
...
const acceptAduan = (id) => {
    Swal.fire({
      ...
      `,
        ...
        if (result.isConfirmed) {
            axios
                .post(route("aduanMlp.accept", { id: id }))
                .then((response) => {
                    Swal.fire({
                        icon: "success",
                        title: "Berhasil!",
...
onMounted(() => {
    ...
    if (!sessionStorage.getItem("guideShownMlp")) {
        Swal.fire({
            title: "Panduan",
            html: `
      ...
      `,
            ...
            sessionStorage.setItem("guideShownMlp", "true");
        });
    }
});
...
const submitCsv = () => {
    ...
    Inertia.post(route("aduanMlp.import"), formData, {
        forceFormData: true,
        onSuccess: () => {
...
function updateUrgency(id, value) {
    ...
    axios
        .post(route("aduanMlp.updateUrgency"), {
            id: id,
            urgency: value,
        })
        .then((res) => {
