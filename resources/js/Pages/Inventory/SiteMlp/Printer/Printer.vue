...
const deleteData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            form.delete(route("printerMlp.delete", { id: id }), {
                onSuccess: () => {
                    Swal.fire({
                        title: "Deleted!",
...
const editData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            form.get(route("printerMlp.edit", { id: id }));
        }
    });
};

const detailData = (id) => {
    form.get(route("printerMlp.detail", { id: id }));
};
...
const submitCsv = () => {
    ...
    formx.post(route("printerMlp.import"), {
        onSuccess: () => {
