...
const deleteData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            form.delete(route("cctvMlp.delete", { id: id }), {
                onSuccess: () => {
                    Swal.fire({
                        title: "Deleted!",
...
const editData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            form.get(route("cctvMlp.edit", { id: id }));
        }
    });
};

const detailData = (id) => {
    form.get(route("cctvMlp.detail", { id: id }));
};
...
const submitCsv = () => {
    ...
    formx.post(route("cctvMlp.import"), {
        onSuccess: () => {
