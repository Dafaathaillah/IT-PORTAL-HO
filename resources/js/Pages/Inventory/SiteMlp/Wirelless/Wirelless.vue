...
const detailData = (id) => {
    form.get(route("wirellessMlp.detail", { id: id }));
};
...
const deleteData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            form.delete(route("wirellessMlp.delete", { id: id }), {
                onSuccess: () => {
                    Swal.fire({
                        title: "Deleted!",
...
const editData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            form.get(route("wirellessMlp.edit", { id: id }));
        }
    });
};
...
const submitCsv = () => {
    ...
    formx.post(route("wirellessMlp.import"), {
        onSuccess: () => {
                ...
                <div class="flex flex-wrap -mx-3">
                    ...
                    <div class="flex-none w-full max-w-full px-3">
                        ...
                        >
                            ...
                            >
                                <Link
                                    :href="route('wirellessMlp.create')"
