...
const props = defineProps(["mtData"]);

const form = useForm({
    id: props.mtData.id,
    inventory_number: props.mtData.inventory_number || "",
    kode_mt: props.mtData.mt_code || "",
    tipe_mt: props.mtData.type_mt || "",
    lokasi_mt: props.mtData.location || "",
    detail_lokasi: props.mtData.detail_location || "",
    kode_gembok: props.mtData.padlock_code || "",
    gps: props.mtData.gps || "",
    lampu_led: props.mtData.led_lamp || "",
    kondisi: props.mtData.condition || "",
    status: props.mtData.status || "",
    note: props.mtData.note || "",
});
...
const editData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            form.get(route("mobileTower.edit", { id: id }));
        }
    });
};
...
const update = () => {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            form.put(route("mobileTower.update", props.mtData.id), {
                onSuccess: () => {
