...
const update = () => {
    ...
    Inertia.post(route("laptopreutilize.update", props.laptop.id), formData, {
        onProgress: (progress) => {
        ...
        <template #header>
            <nav>
                ...
                >
                    ...
                    <Link
                        :href="route('laptopreutilize.page')"
                        ...
                        <div class="flex-auto p-6">
                            <form @submit.prevent="update">
                                ...
                                <div class="flex flex-nowrap mt-6 justify-end">
                                    ...
                                    <Link
                                        :href="route('laptopreutilize.page')"
                                        class="relative inline-flex items-center justify-center p-0.5 mb-2 me-2 overflow-hidden text-sm font-medium text-gray-900 rounded-lg group bg-gradient-to-br from-red-200 via-red-300 to-red-700 group-hover:from-red-200 group-hover:via-red-300 group-hover:to-yellow-200 dark:text-white dark:hover:text-gray-900 focus:ring-4 focus:outline-none focus:ring-red-100 dark:focus:ring-red-400"
                                    >
                                        <span
                                            class="relative px-5 py-2.5 transition-all ease-in duration-75 bg-white dark:bg-gray-900 rounded-md group-hover:bg-opacity-0"
                                        >
