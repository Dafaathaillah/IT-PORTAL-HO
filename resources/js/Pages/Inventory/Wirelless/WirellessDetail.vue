                        ...
                        <div class="w-full max-w-full px-3 mt-6 md:w-12/12 md:flex-none">
                            <div
                                ...
                                <div class="flex flex-row p-6 px-4 pb-0 mb-0 border-b-0 rounded-t-2xl">
                                    ...
                                    <NavLinkCustom class="text-red-700" :href="route('wirelless.page')">
                                        Move to home page
                                    </NavLinkCustom>
                                ...
                                <div class="p-6 px-4 pb-0 grid grid-cols-2 gap-4">
                                    ...
                                    <div class="grid grid-cols-2">
                                        ...
                                        <div>
                                            <p>: {{ wirelless.inventory_number }}</p>
                                        </div>
                                    </div>
                                    <div class="grid grid-cols-2">
                                        <div>
                                    ...
                                    <div class="grid grid-cols-2">
                                        ...
                                        <div>
                                            <p>
                                                :
                                                {{
                                                    formattedDate(wirelless.updated_at)
                                                }}
                                            </p>
                                        </div>
                                    </div>
