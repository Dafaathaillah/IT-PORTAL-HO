...
const deleteData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            form.delete(route("cctvBge.delete", { id: id }), {
                onSuccess: () => {
                    Swal.fire({
                        title: "Deleted!",
...
const editData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            form.get(route("cctvBge.edit", { id: id }));
        }
    });
};

const detailData = (id) => {
    form.get(route("cctvBge.detail", { id: id }));
};
...
const submitCsv = () => {
    ...
    formx.post(route("cctvBge.import"), {
        onSuccess: () => {
