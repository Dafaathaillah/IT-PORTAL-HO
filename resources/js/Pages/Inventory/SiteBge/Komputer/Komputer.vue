...
const deleteData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            form.delete(route("komputerBge.delete", { id: id }), {
                onSuccess: () => {
                    Swal.fire({
                        title: "Deleted!",
...
const editData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            form.get(route("komputerBge.edit", { id: id }));
        }
    });
};

const detailData = (id) => {
    form.get(route("komputerBge.detail", { id: id }));
};
...
const submitCsv = () => {
    ...
    formx.post(route("komputerBge.import"), {
        onSuccess: () => {
