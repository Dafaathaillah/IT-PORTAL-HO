...
const deleteData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            form.delete(route("printerBge.delete", { id: id }), {
                onSuccess: () => {
                    Swal.fire({
                        title: "Deleted!",
...
const editData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            form.get(route("printerBge.edit", { id: id }));
        }
    });
};

const detailData = (id) => {
    form.get(route("printerBge.detail", { id: id }));
};
...
const submitCsv = () => {
    ...
    function reloadPage() {
        ...
        formx.post(route("printerBge.import"), {
        onSuccess: () => {
