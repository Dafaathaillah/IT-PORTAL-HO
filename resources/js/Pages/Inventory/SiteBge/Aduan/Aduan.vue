...
const deleteData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            form.delete(route("aduanBge.delete", { id: id }), {
                onSuccess: () => {
                    Swal.fire({
                        title: "Deleted!",
...
const editData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            form.get(route("aduanBge.edit", { id: id }));
        }
    });
};

const progressAduan = (id) => {
    form.get(route("aduanBge.progress", { id: id }));
};
...
const acceptAduan = (id) => {
    Swal.fire({
      ...
      `,
        ...
        if (result.isConfirmed) {
            axios
                .post(route("aduanBge.accept", { id: id }))
                .then((response) => {
                    Swal.fire({
                        icon: "success",
                        title: "Berhasil!",
...
onMounted(() => {
    ...
    if (!sessionStorage.getItem("guideShownBge")) {
        Swal.fire({
            title: "Panduan",
            html: `
      ...
      `,
            ...
            sessionStorage.setItem("guideShownBge", "true");
        });
    }
});

const detailData = (id) => {
    form.get(route("aduanBge.detail", { id: id }));
};
...
const submitCsv = () => {
    ...
    Inertia.post(route("aduanBge.import"), formData, {
        forceFormData: true,
        onSuccess: () => {
...
function updateUrgency(id, value) {
    ...
    axios
        .post(route("aduanBge.updateUrgency"), {
            id: id,
            urgency: value,
        })
        .then((res) => {
