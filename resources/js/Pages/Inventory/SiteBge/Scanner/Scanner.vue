...
const deleteData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            form.delete(route("scannerBge.delete", { id: id }), {
                onSuccess: () => {
                    Swal.fire({
                        title: "Deleted!",
...
const editData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            form.get(route("scannerBge.edit", { id: id }));
        }
    });
};

const detailData = (id) => {
    form.get(route("scannerBge.detail", { id: id }));
};
...
const submitCsv = () => {
    ...
    formx.post(route("scannerBge.import"), {
        onSuccess: () => {
