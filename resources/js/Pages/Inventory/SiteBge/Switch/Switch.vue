...
const deleteData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            form.delete(route("switchBge.delete", { id: id }), {
                onSuccess: () => {
                    Swal.fire({
                        title: "Deleted!",
...
const editData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            form.get(route("switchBge.edit", { id: id }));
        }
    });
};

const detailData = (id) => {
    form.get(route("switchBge.detail", { id: id }));
};
...
const submitCsv = () => {
    ...
    formx.post(route("switchBge.import"), {
        onSuccess: () => {
