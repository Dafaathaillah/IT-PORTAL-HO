...
const deleteData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            form.delete(route("laptopBge.delete", { id: id }), {
                onSuccess: () => {
                    Swal.fire({
                        title: "Deleted!",
...
const editData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            form.get(route("laptopBge.edit", { id: id }));
        }
    });
};

const detailData = (id) => {
    form.get(route("laptopBge.detail", { id: id }));
};
...
const submitCsv = () => {
    ...
    formx.post(route("laptopBge.import"), {
        onSuccess: () => {
