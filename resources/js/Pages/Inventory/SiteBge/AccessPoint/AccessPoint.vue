...
const deleteData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            form.delete(route("accessPointBge.delete", { id: id }), {
                onSuccess: () => {
                    Swal.fire({
                        title: "Deleted!",
...
const editData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            form.get(route("accessPointBge.edit", { id: id }));
        }
    });
};

const detailData = (id) => {
    form.get(route("accessPointBge.detail", { id: id }));
};
...
const submitCsv = () => {
    ...
    formx.post(route("accessPointBge.import"), {
        onSuccess: () => {
                ...
                <div class="flex flex-wrap -mx-3">
                    ...
                    <div class="flex-none w-full max-w-full px-3">
                        ...
                        >
                            ...
                            >
                                <Link
                                    :href="route('accessPointBge.create')"
