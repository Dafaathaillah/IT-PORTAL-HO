...
const deleteData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            form.delete(route("printerAmi.delete", { id: id }), {
                onSuccess: () => {
                    Swal.fire({
                        title: "Deleted!",
...
const editData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            form.get(route("printerAmi.edit", { id: id }));
        }
    });
};

const detailData = (id) => {
    form.get(route("printerAmi.detail", { id: id }));
};
...
const submitCsv = () => {
    ...
    formx.post(route("printerAmi.import"), {
        onSuccess: () => {
