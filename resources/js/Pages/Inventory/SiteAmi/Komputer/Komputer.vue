...
const deleteData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            form.delete(route("komputerAmi.delete", { id: id }), {
                onSuccess: () => {
                    Swal.fire({
                        title: "Deleted!",
...
const editData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            form.get(route("komputerAmi.edit", { id: id }));
        }
    });
};

const detailData = (id) => {
    form.get(route("komputerAmi.detail", { id: id }));
};
...
const submitCsv = () => {
    ...
    formx.post(route("komputerAmi.import"), {
        onSuccess: () => {
