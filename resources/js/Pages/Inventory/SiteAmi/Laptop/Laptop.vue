...
const deleteData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            form.delete(route("laptopAmi.delete", { id: id }), {
                onSuccess: () => {
                    Swal.fire({
                        title: "Deleted!",
...
const editData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            form.get(route("laptopAmi.edit", { id: id }));
        }
    });
};

const detailData = (id) => {
    form.get(route("laptopAmi.detail", { id: id }));
};
...
const submitCsv = () => {
    ...
    formx.post(route("laptopAmi.import"), {
        onSuccess: () => {
