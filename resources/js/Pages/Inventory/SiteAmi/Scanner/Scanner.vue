...
const deleteData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            form.delete(route("scannerAmi.delete", { id: id }), {
                onSuccess: () => {
                    Swal.fire({
                        title: "Deleted!",
...
const editData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            form.get(route("scannerAmi.edit", { id: id }));
        }
    });
};

const detailData = (id) => {
    form.get(route("scannerAmi.detail", { id: id }));
};
...
const submitCsv = () => {
    ...
    formx.post(route("scannerAmi.import"), {
        onSuccess: () => {
