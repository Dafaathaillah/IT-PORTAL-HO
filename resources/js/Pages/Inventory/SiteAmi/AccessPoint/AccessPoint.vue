...
const deleteData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            form.delete(route("accessPointAmi.delete", { id: id }), {
                onSuccess: () => {
                    Swal.fire({
                        title: "Deleted!",
...
const editData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            form.get(route("accessPointAmi.edit", { id: id }));
        }
    });
};

const detailData = (id) => {
    form.get(route("accessPointAmi.detail", { id: id }));
};
...
const submitCsv = () => {
    ...
    formx.post(route("accessPointAmi.import"), {
        onSuccess: () => {
            Swal.fire({
                title: "Success!",
                ...
                <div class="flex flex-wrap -mx-3">
                    ...
                    <div class="flex-none w-full max-w-full px-3">
                        ...
                        >
                            ...
                            >
                                <Link
                                    :href="route('accessPointAmi.create')"
