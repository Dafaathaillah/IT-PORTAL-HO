...
const deleteData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            form.delete(route("switchAmi.delete", { id: id }), {
                onSuccess: () => {
                    Swal.fire({
                        title: "Deleted!",
...
const editData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            form.get(route("switchAmi.edit", { id: id }));
        }
    });
};

const detailData = (id) => {
    form.get(route("switchAmi.detail", { id: id }));
};
...
const submitCsv = () => {
    ...
    formx.post(route("switchAmi.import"), {
        onSuccess: () => {
