...
const deleteData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            form.delete(route("scannerIpt.delete", { id: id }), {
                onSuccess: () => {
                    Swal.fire({
                        title: "Deleted!",
...
const editData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            form.get(route("scannerIpt.edit", { id: id }));
        }
    });
};

const detailData = (id) => {
    form.get(route("scannerIpt.detail", { id: id }));
};
...
const submitCsv = () => {
    ...
    formx.post(route("scannerIpt.import"), {
        onSuccess: () => {
