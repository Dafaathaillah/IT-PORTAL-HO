...
const deleteData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            form.delete(route("printerIpt.delete", { id: id }), {
                onSuccess: () => {
                    Swal.fire({
                        title: "Deleted!",
...
const editData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            form.get(route("printerIpt.edit", { id: id }));
        }
    });
};

const detailData = (id) => {
    form.get(route("printerIpt.detail", { id: id }));
};
...
const submitCsv = () => {
    ...
    formx.post(route("printerIpt.import"), {
        onSuccess: () => {
