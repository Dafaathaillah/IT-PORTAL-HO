...
const deleteData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            form.delete(route("cctvIpt.delete", { id: id }), {
                onSuccess: () => {
                    Swal.fire({
                        title: "Deleted!",
...
const editData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            form.get(route("cctvIpt.edit", { id: id }));
        }
    });
};

const detailData = (id) => {
    form.get(route("cctvIpt.detail", { id: id }));
};
...
const submitCsv = () => {
    ...
    formx.post(route("cctvIpt.import"), {
        onSuccess: () => {
