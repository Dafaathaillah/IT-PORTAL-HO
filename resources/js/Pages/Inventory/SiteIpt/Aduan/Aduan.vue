...
const deleteData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            form.delete(route("aduanIpt.delete", { id: id }), {
                onSuccess: () => {
                    Swal.fire({
                        title: "Deleted!",
...
const editData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            form.get(route("aduanIpt.edit", { id: id }));
        }
    });
};

const progressAduan = (id) => {
    form.get(route("aduanIpt.progress", { id: id }));
};
...
const acceptAduan = (id) => {
    Swal.fire({
      ...
      `,
        ...
        if (result.isConfirmed) {
            axios
                .post(route("aduanIpt.accept", { id: id }))
                .then((response) => {
                    Swal.fire({
                        icon: "success",
                        title: "Berhasil!",
...
onMounted(() => {
    ...
    if (!sessionStorage.getItem("guideShownIpt")) {
        Swal.fire({
            title: "Panduan",
            html: `
      ...
      `,
            ...
            sessionStorage.setItem("guideShownIpt", "true");
        });
    }
});

const detailData = (id) => {
    form.get(route("aduanIpt.detail", { id: id }));
};
...
const submitCsv = () => {
    ...
    Inertia.post(route("aduanIpt.import"), formData, {
        forceFormData: true,
        onSuccess: () => {
...
function updateUrgency(id, value) {
    ...
    axios
        .post(route("aduanIpt.updateUrgency"), {
            id: id,
            urgency: value,
        })
        .then((res) => {
