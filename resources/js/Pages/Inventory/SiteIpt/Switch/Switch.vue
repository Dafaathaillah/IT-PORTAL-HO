...
const deleteData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            form.delete(route("switchIpt.delete", { id: id }), {
                onSuccess: () => {
                    Swal.fire({
                        title: "Deleted!",
...
const editData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            form.get(route("switchIpt.edit", { id: id }));
        }
    });
};

const detailData = (id) => {
    form.get(route("switchIpt.detail", { id: id }));
};
...
const submitCsv = () => {
    ...
    formx.post(route("switchIpt.import"), {
        onSuccess: () => {
