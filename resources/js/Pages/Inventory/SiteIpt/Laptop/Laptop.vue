...
const deleteData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            form.delete(route("laptopIpt.delete", { id: id }), {
                onSuccess: () => {
                    Swal.fire({
                        title: "Deleted!",
...
const editData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            form.get(route("laptopIpt.edit", { id: id }));
        }
    });
};

const detailData = (id) => {
    form.get(route("laptopIpt.detail", { id: id }));
};
...
const submitCsv = () => {
    ...
    formx.post(route("laptopIpt.import"), {
        onSuccess: () => {
