...
const deleteData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            form.delete(route("accessPointDmp.delete", { id: id }), {
                onSuccess: () => {
                    Swal.fire({
                        title: "Deleted!",
...
const editData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            form.get(route("accessPointDmp.edit", { id: id }));
        }
    });
};

const detailData = (id) => {
    form.get(route("accessPointDmp.detail", { id: id }));
};
...
const submitCsv = () => {
    ...
    formx.post(route("accessPointDmp.import"), {
        onSuccess: () => {
                ...
                <div class="flex flex-wrap -mx-3">
                    ...
                    <div class="flex-none w-full max-w-full px-3">
                        ...
                        >
                            ...
                            >
                                <Link
                                    :href="route('accessPointDmp.create')"
