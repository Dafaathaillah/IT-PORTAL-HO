...
const deleteData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            form.delete(route("switchDmp.delete", { id: id }), {
                onSuccess: () => {
                    Swal.fire({
                        title: "Deleted!",
...
const editData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            form.get(route("switchDmp.edit", { id: id }));
        }
    });
};

const detailData = (id) => {
    form.get(route("switchDmp.detail", { id: id }));
};
...
const submitCsv = () => {
    ...
    formx.post(route("switchDmp.import"), {
        onSuccess: () => {
