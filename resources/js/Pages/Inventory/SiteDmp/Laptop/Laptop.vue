...
const deleteData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            form.delete(route("laptopDmp.delete", { id: id }), {
                onSuccess: () => {
                    Swal.fire({
                        title: "Deleted!",
...
const editData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            form.get(route("laptopDmp.edit", { id: id }));
        }
    });
};

const detailData = (id) => {
    form.get(route("laptopDmp.detail", { id: id }));
};
...
const submitCsv = () => {
    ...
    formx.post(route("laptopDmp.import"), {
        onSuccess: () => {
