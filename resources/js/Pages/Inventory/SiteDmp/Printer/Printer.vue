...
const deleteData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            form.delete(route("printerDmp.delete", { id: id }), {
                onSuccess: () => {
                    Swal.fire({
                        title: "Deleted!",
...
const editData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            form.get(route("printerDmp.edit", { id: id }));
        }
    });
};

const detailData = (id) => {
    form.get(route("printerDmp.detail", { id: id }));
};
...
const submitCsv = () => {
    ...
    formx.post(route("printerDmp.import"), {
        onSuccess: () => {
