...
const deleteData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            form.delete(route("scannerDmp.delete", { id: id }), {
                onSuccess: () => {
                    Swal.fire({
                        title: "Deleted!",
...
const editData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            form.get(route("scannerDmp.edit", { id: id }));
        }
    });
};

const detailData = (id) => {
    form.get(route("scannerDmp.detail", { id: id }));
};
...
const submitCsv = () => {
    ...
    formx.post(route("scannerDmp.import"), {
        onSuccess: () => {
