...
const deleteData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            form.delete(route("komputerDmp.delete", { id: id }), {
                onSuccess: () => {
                    Swal.fire({
                        title: "Deleted!",
...
const editData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            form.get(route("komputerDmp.edit", { id: id }));
        }
    });
};

const detailData = (id) => {
    form.get(route("komputerDmp.detail", { id: id }));
};
...
const submitCsv = () => {
    ...
    formx.post(route("komputerDmp.import"), {
        onSuccess: () => {
