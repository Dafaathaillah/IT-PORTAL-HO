...
const deleteData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            form.delete(route("komputerMip.delete", { id: id }), {
                onSuccess: () => {
                    Swal.fire({
                        title: "Deleted!",
...
const editData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            form.get(route("komputerMip.edit", { id: id }));
        }
    });
};

const detailData = (id) => {
    form.get(route("komputerMip.detail", { id: id }));
};
...
const submitCsv = () => {
    ...
    formx.post(route("komputerMip.import"), {
        onSuccess: () => {
