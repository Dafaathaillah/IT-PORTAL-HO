...
const deleteData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            form.delete(route("scannerMip.delete", { id: id }), {
                onSuccess: () => {
                    Swal.fire({
                        title: "Deleted!",
...
const editData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            form.get(route("scannerMip.edit", { id: id }));
        }
    });
};

const detailData = (id) => {
    form.get(route("scannerMip.detail", { id: id }));
};
...
const submitCsv = () => {
    ...
    formx.post(route("scannerMip.import"), {
        onSuccess: () => {
