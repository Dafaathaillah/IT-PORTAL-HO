...
const deleteData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            form.delete(route("switchMip.delete", { id: id }), {
                onSuccess: () => {
                    Swal.fire({
                        title: "Deleted!",
...
const editData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            form.get(route("switchMip.edit", { id: id }));
        }
    });
};

const detailData = (id) => {
    form.get(route("switchMip.detail", { id: id }));
};
...
const submitCsv = () => {
    ...
    formx.post(route("switchMip.import"), {
        onSuccess: () => {
