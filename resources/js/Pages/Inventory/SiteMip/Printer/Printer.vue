...
const deleteData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            form.delete(route("printerMip.delete", { id: id }), {
                onSuccess: () => {
                    Swal.fire({
                        title: "Deleted!",
...
const editData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            form.get(route("printerMip.edit", { id: id }));
        }
    });
};

const detailData = (id) => {
    form.get(route("printerMip.detail", { id: id }));
};
...
const submitCsv = () => {
    ...
    formx.post(route("printerMip.import"), {
        onSuccess: () => {
