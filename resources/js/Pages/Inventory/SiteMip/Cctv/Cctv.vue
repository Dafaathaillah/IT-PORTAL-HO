...
const deleteData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            form.delete(route("cctvMip.delete", { id: id }), {
                onSuccess: () => {
                    Swal.fire({
                        title: "Deleted!",
...
const editData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            form.get(route("cctvMip.edit", { id: id }));
        }
    });
};

const detailData = (id) => {
    form.get(route("cctvMip.detail", { id: id }));
};
...
const submitCsv = () => {
    ...
    formx.post(route("cctvMip.import"), {
        onSuccess: () => {
