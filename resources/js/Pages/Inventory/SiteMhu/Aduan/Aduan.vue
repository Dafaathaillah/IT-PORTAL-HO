...
const deleteData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            form.delete(route("aduanMhu.delete", { id: id }), {
                onSuccess: () => {
                    Swal.fire({
                        title: "Deleted!",
...
const editData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            form.get(route("aduanMhu.edit", { id: id }));
        }
    });
};

const progressAduan = (id) => {
    form.get(route("aduanMhu.progress", { id: id }));
};

const detailData = (id) => {
    form.get(route("aduanMhu.detail", { id: id }));
};
...
const acceptAduan = (id) => {
    Swal.fire({
      ...
      `,
        ...
        if (result.isConfirmed) {
            axios
                .post(route("aduanMhu.accept", { id: id }))
                .then((response) => {
                    Swal.fire({
                        icon: "success",
                        title: "Berhasil!",
...
onMounted(() => {
    ...
    if (!sessionStorage.getItem("guideShownMhu")) {
        Swal.fire({
            title: "Panduan",
            html: `
      ...
      `,
            ...
            sessionStorage.setItem("guideShownMhu", "true");
        });
    }
});
...
const submitCsv = () => {
    ...
    Inertia.post(route("aduanMhu.import"), formData, {
        forceFormData: true,
        onSuccess: () => {
...
function updateUrgency(id, value) {
    ...
    axios
        .post(route("aduanMhu.updateUrgency"), {
            id: id,
            urgency: value,
        })
        .then((res) => {
