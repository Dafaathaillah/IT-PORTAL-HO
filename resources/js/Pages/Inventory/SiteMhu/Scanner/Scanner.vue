...
const deleteData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            form.delete(route("scannerMhu.delete", { id: id }), {
                onSuccess: () => {
                    Swal.fire({
                        title: "Deleted!",
...
const editData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            form.get(route("scannerMhu.edit", { id: id }));
        }
    });
};

const detailData = (id) => {
    form.get(route("scannerMhu.detail", { id: id }));
};
...
const submitCsv = () => {
    ...
    formx.post(route("scannerMhu.import"), {
        onSuccess: () => {
