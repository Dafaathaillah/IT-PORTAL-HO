...
const deleteData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            form.delete(route("komputerMhu.delete", { id: id }), {
                onSuccess: () => {
                    Swal.fire({
                        title: "Deleted!",
...
const editData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            form.get(route("komputerMhu.edit", { id: id }));
        }
    });
};

const detailData = (id) => {
    form.get(route("komputerMhu.detail", { id: id }));
};
