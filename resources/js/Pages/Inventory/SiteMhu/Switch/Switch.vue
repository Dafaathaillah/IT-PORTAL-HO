...
const deleteData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            form.delete(route("switchMhu.delete", { id: id }), {
                onSuccess: () => {
                    Swal.fire({
                        title: "Deleted!",
...
const editData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            form.get(route("switchMhu.edit", { id: id }));
        }
    });
};

const detailData = (id) => {
    form.get(route("switchMhu.detail", { id: id }));
};
...
const submitCsv = () => {
    ...
    formx.post(route("switchMhu.import"), {
        onSuccess: () => {
