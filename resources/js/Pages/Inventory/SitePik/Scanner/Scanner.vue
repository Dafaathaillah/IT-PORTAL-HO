...
const deleteData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            form.delete(route("scannerPik.delete", { id: id }), {
                onSuccess: () => {
                    Swal.fire({
                        title: "Deleted!",
...
const editData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            form.get(route("scannerPik.edit", { id: id }));
        }
    });
};

const detailData = (id) => {
    form.get(route("scannerPik.detail", { id: id }));
};
...
const submitCsv = () => {
    ...
    formx.post(route("scannerPik.import"), {
        onSuccess: () => {
