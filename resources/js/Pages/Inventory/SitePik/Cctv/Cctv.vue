...
const deleteData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            form.delete(route("cctvPik.delete", { id: id }), {
                onSuccess: () => {
                    Swal.fire({
                        title: "Deleted!",
...
const editData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            form.get(route("cctvPik.edit", { id: id }));
        }
    });
};

const detailData = (id) => {
    form.get(route("cctvPik.detail", { id: id }));
};
...
const submitCsv = () => {
    ...
    formx.post(route("cctvPik.import"), {
        onSuccess: () => {
