...
const deleteData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            form.delete(route("laptopPik.delete", { id: id }), {
                onSuccess: () => {
                    Swal.fire({
                        title: "Deleted!",
...
const editData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            form.get(route("laptopPik.edit", { id: id }));
        }
    });
};

const detailData = (id) => {
    form.get(route("laptopPik.detail", { id: id }));
};
...
const submitCsv = () => {
    ...
    formx.post(route("laptopPik.import"), {
        onSuccess: () => {
