...
const deleteData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            form.delete(route("switchPik.delete", { id: id }), {
                onSuccess: () => {
                    Swal.fire({
                        title: "Deleted!",
...
const editData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            form.get(route("switchPik.edit", { id: id }));
        }
    });
};

const detailData = (id) => {
    form.get(route("switchPik.detail", { id: id }));
};
...
const submitCsv = () => {
    ...
    formx.post(route("switchPik.import"), {
        onSuccess: () => {
