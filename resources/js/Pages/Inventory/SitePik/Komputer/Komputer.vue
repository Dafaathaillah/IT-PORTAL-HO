...
const deleteData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            form.delete(route("komputerPik.delete", { id: id }), {
                onSuccess: () => {
                    Swal.fire({
                        title: "Deleted!",
...
const editData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            form.get(route("komputerPik.edit", { id: id }));
        }
    });
};

const detailData = (id) => {
    form.get(route("komputerPik.detail", { id: id }));
};
...
const submitCsv = () => {
    ...
    formx.post(route("komputerPik.import"), {
        onSuccess: () => {
