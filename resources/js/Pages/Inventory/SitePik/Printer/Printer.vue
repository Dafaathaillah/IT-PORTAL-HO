...
const deleteData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            form.delete(route("printerPik.delete", { id: id }), {
                onSuccess: () => {
                    Swal.fire({
                        title: "Deleted!",
...
const editData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            form.get(route("printerPik.edit", { id: id }));
        }
    });
};

const detailData = (id) => {
    form.get(route("printerPik.detail", { id: id }));
};
...
const submitCsv = () => {
    ...
    formx.post(route("printerPik.import"), {
        onSuccess: () => {
