...
const deleteData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            form.delete(route("switchWARA.delete", { id: id }), {
                onSuccess: () => {
                    Swal.fire({
                        title: "Deleted!",
...
const editData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            form.get(route("switchWARA.edit", { id: id }));
        }
    });
};

const detailData = (id) => {
    form.get(route("switchWARA.detail", { id: id }));
};
...
const submitCsv = () => {
    ...
    formx.post(route("switchWARA.import"), {
        onSuccess: () => {
