...
const deleteData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            form.delete(route("laptopWARA.delete", { id: id }), {
                onSuccess: () => {
                    Swal.fire({
                        title: "Deleted!",
...
const editData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            form.get(route("laptopWARA.edit", { id: id }));
        }
    });
};

const detailData = (id) => {
    form.get(route("laptopWARA.detail", { id: id }));
};
...
const submitCsv = () => {
    ...
    formx.post(route("laptopWARA.import"), {
        onSuccess: () => {
