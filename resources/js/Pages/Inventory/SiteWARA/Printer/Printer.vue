...
const deleteData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            form.delete(route("printerWARA.delete", { id: id }), {
                onSuccess: () => {
                    Swal.fire({
                        title: "Deleted!",
...
const editData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            form.get(route("printerWARA.edit", { id: id }));
        }
    });
};

const detailData = (id) => {
    form.get(route("printerWARA.detail", { id: id }));
};
...
const submitCsv = () => {
    ...
    formx.post(route("printerWARA.import"), {
        onSuccess: () => {
