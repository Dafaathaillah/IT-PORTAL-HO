...
const deleteData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            form.delete(route("cctvWARA.delete", { id: id }), {
                onSuccess: () => {
                    Swal.fire({
                        title: "Deleted!",
...
const editData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            form.get(route("cctvWARA.edit", { id: id }));
        }
    });
};

const detailData = (id) => {
    form.get(route("cctvWARA.detail", { id: id }));
};
...
const submitCsv = () => {
    ...
    formx.post(route("cctvWARA.import"), {
        onSuccess: () => {
