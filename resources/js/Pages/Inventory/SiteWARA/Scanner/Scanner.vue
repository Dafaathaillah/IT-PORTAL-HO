...
const deleteData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            form.delete(route("scannerWARA.delete", { id: id }), {
                onSuccess: () => {
                    Swal.fire({
                        title: "Deleted!",
...
const editData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            form.get(route("scannerWARA.edit", { id: id }));
        }
    });
};

const detailData = (id) => {
    form.get(route("scannerWARA.detail", { id: id }));
};
...
const submitCsv = () => {
    ...
    formx.post(route("scannerWARA.import"), {
        onSuccess: () => {
