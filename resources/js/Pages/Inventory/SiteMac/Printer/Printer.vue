...
const deleteData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            form.delete(route("printerMac.delete", { id: id }), {
                onSuccess: () => {
                    Swal.fire({
                        title: "Deleted!",
...
const editData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            form.get(route("printerMac.edit", { id: id }));
        }
    });
};

const detailData = (id) => {
    form.get(route("printerMac.detail", { id: id }));
};
...
const submitCsv = () => {
    ...
    formx.post(route("printerMac.import"), {
        onSuccess: () => {
