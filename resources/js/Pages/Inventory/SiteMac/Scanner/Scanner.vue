...
const deleteData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            form.delete(route("scannerMac.delete", { id: id }), {
                onSuccess: () => {
                    Swal.fire({
                        title: "Deleted!",
...
const editData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            form.get(route("scannerMac.edit", { id: id }));
        }
    });
};

const detailData = (id) => {
    form.get(route("scannerMac.detail", { id: id }));
};
...
const submitCsv = () => {
    ...
    formx.post(route("scannerMac.import"), {
        onSuccess: () => {
