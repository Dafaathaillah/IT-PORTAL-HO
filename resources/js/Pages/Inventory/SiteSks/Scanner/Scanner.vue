...
const deleteData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            form.delete(route("scannerSks.delete", { id: id }), {
                onSuccess: () => {
                    Swal.fire({
                        title: "Deleted!",
...
const editData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            form.get(route("scannerSks.edit", { id: id }));
        }
    });
};

const detailData = (id) => {
    form.get(route("scannerSks.detail", { id: id }));
};
...
const submitCsv = () => {
    ...
    formx.post(route("scannerSks.import"), {
        onSuccess: () => {
