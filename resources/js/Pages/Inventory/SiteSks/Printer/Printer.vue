...
const deleteData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            form.delete(route("printerSks.delete", { id: id }), {
                onSuccess: () => {
                    Swal.fire({
                        title: "Deleted!",
...
const editData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            form.get(route("printerSks.edit", { id: id }));
        }
    });
};

const detailData = (id) => {
    form.get(route("printerSks.detail", { id: id }));
};
...
const submitCsv = () => {
    ...
    formx.post(route("printerSks.import"), {
        onSuccess: () => {
