...
const restore = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            form.patch(route("laptopRcBin.restore", { id: id }), {
                onSuccess: () => {
                    Swal.fire({
                        title: "Restored!",
...
const forceDeleted = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            // Perform the delete operation, e.g., by making a request to the server
            form.delete(route("laptopRcBin.forceDelete", { id: id }), {
                onSuccess: () => {
                    Swal.fire({
                        title: "Deleted!",
...
const detailData = (id) => {
    form.get(route("laptopRcBin.detail", { id: id }));
};
...
<template>
    <Head title="RecycleBin Inv Laptop" />
