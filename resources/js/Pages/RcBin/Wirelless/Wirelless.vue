...
const restore = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            form.patch(route("wirellessRcBin.restore", { id: id }), {
                onSuccess: () => {
                    Swal.fire({
                        title: "Restored!",
...
const forceDeleted = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            // Perform the delete operation, e.g., by making a request to the server
            form.delete(route("wirellessRcBin.forceDelete", { id: id }), {
                onSuccess: () => {
                    Swal.fire({
                        title: "Deleted!",
...
const detailData = (id) => {
    form.get(route("wirellessRcBin.detail", { id: id }));
};
...
const submitCsv = () => {
    ...
    formx.post(route("wirellessRcBin.import"), {
        onSuccess: () => {
                ...
                <div class="flex flex-wrap -mx-3">
                    ...
                    <div class="flex-none w-full max-w-full px-3">
                        ...
                        >
                            ...
                            >
                                <Link
                                    :href="route('wirellessRcBin.create')"
