...
watch(selectedOptionDeptPrev, async (newDept) => {
    // console.log(selectedOptionDeptPrev.value.code)
    if (!selectedOption.value || !selectedOption.value.name) {
        ...
        selectedOptionDeptPrev.value = null; // Reset select department
        return;
    }
    ...
    try {
        ...
        // Set data ke dropdown inventory
...
watch(selectedOptionInvNumber, async (newInvNumber) => {
    ...
    try {
        ...
        form.spek = response.data.inventoryData.spesifikasi;
        form.prevNrp = response.data.inventoryData.pengguna.nrp;
        form.prevUsername = response.data.inventoryData.pengguna.username;
    } catch (error) {
        console.error("❌ Gagal mengambil data inventory:", error);
                    ...
                    >
                        ...
                        <div class="flex-auto p-6">
                            <form @submit.prevent="save">
                                ...
                                >
                                    <Link
                                        :href="route('pengalihanAsset.page', { site: page.props.site })"
