...
const editData = (id) => {
    form.get(route("inspeksiPrinterBge.edit", { id: id }));
...
const detailData = (id) => {
    form.get(route("inspeksiPrinterBge.detail", { id: id }));
};

const processData = (id) => {
    form.get(route("inspeksiPrinterBge.process", { id: id }));
};
