                    ...
                    <div class="w-full max-w-full px-3 mt-6 md:w-7/12 md:flex-none">
                        <div
                            ...
                            <div class="flex flex-row p-6 px-4 pb-0 mb-0 border-b-0 rounded-t-2xl">
                                ...
                                <NavLinkCustom class="text-red-700" :href="route('inspeksiKomputer.page')">
                                    Move to home page
                                </NavLinkCustom>
                            ...
                            <div class="flex flex-wrap -mx-3 p-12">
                                ...
                                <div class="w-full max-w-full px-3 shrink-0 md:w-3/12 md:flex-0">
                                    <div class="mb-4">
                                        <label for="number-asset-ho"
                                            class="inline-block mb-2 ml-1 text-sm text-slate-700 dark:text-white/80">CPU</label>
                                ...
                                <div class="w-full max-w-full px-3 shrink-0 md:w-3/12 md:flex-0">
                                    <div class="mb-4">
                                        <label for="device-name"
                                            ...
                                            : {{ inspeksi.physique_condition_cpu == 'N' ? 'Tidak Aman' : 'Aman'
                                            }}</label>
                                    </div>
                                </div>
                                <div class="w-full max-w-full px-3 shrink-0 md:w-3/12 md:flex-0">
                                    <div class="mb-4">
                                        <label for="assets-category"
                                            class="inline-block mb-2 ml-1 text-sm text-slate-700 dark:text-white/80">MONITOR</label>
                                ...
                                <div class="w-full max-w-full px-3 shrink-0 md:w-3/12 md:flex-0">
                                    <div class="mb-4">
                                        <label for="device-name"
                                            class="inline-block mb-2 ml-1 text-sm text-slate-700 dark:text-white/80 font-bold">
                                            : {{ inspeksi.physique_condition_monitor == 'N' ? 'Tidak Aman' : 'Aman'
                                            }}</label>
                                    </div>
                                </div>
                                ...
                                <div class="w-full max-w-full px-3 shrink-0 md:w-3/12 md:flex-0">
                                    <div class="mb-4">
                                        <label for="aplikasi"
                                            class="inline-block mb-2 ml-1 text-sm text-slate-700 dark:text-white/80">LISENSI</label>
                                ...
                                <div class="w-full max-w-full px-3 shrink-0 md:w-3/12 md:flex-0">
                                    <div class="mb-4">
                                        <label for="device-name"
                                            class="inline-block mb-2 ml-1 text-sm text-slate-700 dark:text-white/80 font-bold">
                                            : {{ inspeksi.software_license == 'N' ? 'Tidak Aman' : 'Aman' }}</label>
                                    </div>
                                </div>
                                <div class="w-full max-w-full px-3 shrink-0 md:w-3/12 md:flex-0">
                                    <div class="mb-4">
                                        <label for="license"
                                            class="inline-block mb-2 ml-1 text-sm text-slate-700 dark:text-white/80">STANDARISASI</label>
                                ...
                                <div class="w-full max-w-full px-3 shrink-0 md:w-3/12 md:flex-0">
                                    <div class="mb-4">
                                        <label for="device-name"
                                            class="inline-block mb-2 ml-1 text-sm text-slate-700 dark:text-white/80 font-bold">
                                            : {{ inspeksi.software_standaritation == 'N' ? 'Tidak Aman' : 'Aman'
                                            }}</label>
                                    </div>
                                </div>
                                ...
                                <div class="w-full max-w-full px-3 shrink-0 md:w-3/12 md:flex-0">
                                    <div class="mb-4">
                                        <label for="ip-address"
                                            class="inline-block mb-2 ml-1 text-sm text-slate-700 dark:text-white/80">CLEAR
                                            CACHE</label>
                                ...
                                <div class="w-full max-w-full px-3 shrink-0 md:w-3/12 md:flex-0">
                                    <div class="mb-4">
                                        <label for="device-name"
                                            class="inline-block mb-2 ml-1 text-sm text-slate-700 dark:text-white/80 font-bold">
                                            : {{ inspeksi.software_clear_cache == 'N' ? 'Tidak Aman' : 'Aman' }}</label>
                                    </div>
                                </div>
                                ...
                                <div class="w-full max-w-full px-3 shrink-0 md:w-3/12 md:flex-0">
                                    <div class="mb-4">
                                        <label for="ssd_persen"
                                            class="inline-block mb-2 ml-1 text-sm text-slate-700 dark:text-white/80">SYSTEM
                                            RESTORE</label>
                                ...
                                <div class="w-full max-w-full px-3 shrink-0 md:w-3/12 md:flex-0">
                                    <div class="mb-4">
                                        <label for="device-name"
                                            class="inline-block mb-2 ml-1 text-sm text-slate-700 dark:text-white/80 font-bold">
                                            : {{ inspeksi.software_system_restore == 'N' ? 'Tidak Aman' : 'Aman'
                                            }}</label>
                                    </div>
                                </div>
                                ...
                                <div class="w-full max-w-full px-3 shrink-0 md:w-3/12 md:flex-0">
                                    <div class="mb-4">
                                        <label for="device-name"
                                            class="inline-block mb-2 ml-1 text-sm text-slate-700 dark:text-white/80 font-bold">
                                            : {{ inspeksi.defrag == 'N' ? 'Tidak Aman' : 'Aman' }}</label>
                                    </div>
                                </div>
                                ...
                                <div class="w-full max-w-full px-3 shrink-0 md:w-3/12 md:flex-0">
                                    <div class="mb-4">
                                        <label for="device-name"
                                            class="inline-block mb-2 ml-1 text-sm text-slate-700 dark:text-white/80">MAINTENANCE
                                            BERAT</label>
                                    </div>
                                </div>
                                <div class="w-full max-w-full px-3 shrink-0 md:w-3/12 md:flex-0">
                                    <div class="mb-4">
                                        <label for="device-name"
                                            class="inline-block mb-2 ml-1 text-sm text-slate-700 dark:text-white/80 font-bold">
                                            : {{ inspeksi.hard_maintenance == 'N' ? 'Tidak Aman' : 'Aman' }}</label>
                                    </div>
                                </div>
                                ...
                                <div class="w-full max-w-full px-3 shrink-0 md:w-3/12 md:flex-0">
                                    <div class="mb-4">
                                        <label for="device-name"
                                            class="inline-block mb-2 ml-1 text-sm text-slate-700 dark:text-white/80 font-bold">
                                            : {{ inspeksi.condition == '' ? '-' : inspeksi.condition }}</label>
                                    </div>
                                </div>
                                ...
                                <div class="w-full max-w-full px-3 shrink-0 md:w-3/12 md:flex-0">
                                    <div class="mb-4">
                                        <label for="device-name"
                                            class="inline-block mb-2 ml-1 text-sm text-slate-700 dark:text-white/80 font-bold">
                                            : {{ inspeksi.inventory_status == '-' ? '-' : inspeksi.inventory_status
                                            }}</label>
                                    </div>
                                </div>
                                ...
                                <div class="w-full max-w-full px-3 shrink-0 md:w-6/12 md:flex-0">
                                    <div class="mb-4">
                                        <label for="device-name"
                                            class="inline-block mb-2 ml-1 text-sm text-slate-700 dark:text-white/80 font-bold">
                                            : {{ inspeksi.findings == null ? '-' : inspeksi.findings }}</label>
                                    </div>
                                </div>
                                ...
                                <div class="w-full max-w-full px-3 shrink-0 md:w-6/12 md:flex-0">
                                    <div class="mb-4">
                                        <label for="device-name"
                                            class="inline-block mb-2 ml-1 text-sm text-slate-700 dark:text-white/80 font-bold">
                                            : {{ inspeksi.findings_action == null ? '-' : inspeksi.findings_action
                                            }}</label>
                                    </div>
                                </div>
                                ...
                                <div class="w-full max-w-full px-3 shrink-0 md:w-6/12 md:flex-0">
                                    <div class="mb-4">
                                        <label for="device-name"
                                            class="inline-block mb-2 ml-1 text-sm text-slate-700 dark:text-white/80 font-bold">
                                            : {{ inspeksi.due_date == null ? '-' : formattedDate(inspeksi.due_date)
                                            }}</label>
                                    </div>
                                </div>
                                ...
                                <div class="w-full max-w-full px-3 shrink-0 md:w-6/12 md:flex-0">
                                    <div class="mb-4">
                                        <label for="device-name"
                                            class="inline-block mb-2 ml-1 text-sm text-slate-700 dark:text-white/80 font-bold">
                                            : {{ inspeksi.findings_status == null ? '-' : inspeksi.findings_status
                                            }}</label>
                                    </div>
                                </div>
                                ...
                                <div class="w-full max-w-full px-3 shrink-0 md:w-6/12 md:flex-0">
                                    <div class="mb-4">
                                        <label for="device-name"
                                            class="inline-block mb-2 ml-1 text-sm text-slate-700 dark:text-white/80 font-bold">
                                            : {{ inspeksi.remarks == null ? '-' : inspeksi.remarks }}</label>
                                    </div>
                                </div>
                                ...
                                <div class="w-full max-w-full px-3 shrink-0 md:w-6/12 md:flex-0">
                                    <div class="mb-4">
                                        <label for="device-name"
                                            class="inline-block mb-2 ml-1 text-sm text-slate-700 dark:text-white/80 font-bold">
                                            : {{ inspeksi.inspector == '' ? '-' : inspeksi.inspector }}</label>
                                    </div>
                                </div>
                        ...
                        <div
                            ...
                            <div class="flex-auto p-4 pt-6">
                                <div class="grid grid-cols-2">
                                    ...
                                    <div>
                                        <p>: {{ inspeksi.computer.computer_code }}</p>
                                    </div>
                                </div>
                                <div class="grid grid-cols-2">
                                    <div>
                                    ...
                                    <div>
                                        <p>: {{ inspeksi.computer.number_asset_ho }}</p>
                                    </div>
                                </div>
                                <div class="grid grid-cols-2">
                                    <div>
                                    ...
                                    <div>
                                        <p>: {{ inspeksi.computer.pengguna.username }}</p>
                                    </div>
                                </div>
                                <div class="grid grid-cols-2">
                                    <div>
                                    ...
                                    <div>
                                        <p>: {{ inspeksi.computer.computer_name }}</p>
                                    </div>
                                </div>
                                <div class="grid grid-cols-2">
                                    <div>
                                    ...
                                    <div>
                                        <p>: {{ inspeksi.computer.assets_category }}</p>
                                    </div>
                                </div>
                                <div class="grid grid-cols-2">
                                    <div>
                                    ...
                                    <div>
                                        <p>: {{ inspeksi.computer.spesifikasi }}</p>
                                    </div>
                                </div>
                                <div class="grid grid-cols-2">
                                    <div>
                                    ...
                                    <div>
                                        <p>: {{ inspeksi.computer.serial_number }}</p>
                                    </div>
                                </div>
                                <div class="grid grid-cols-2">
                                    <div>
                                    ...
                                    <div>
                                        <p>: {{ inspeksi.computer.aplikasi }}</p>
                                    </div>
                                </div>
                                <div class="grid grid-cols-2">
                                    <div>
                                ...
                                <div class="grid grid-cols-2">
                                    ...
                                    <div>
                                        <p>: {{ inspeksi.computer.ip_address }}</p>
                                    </div>
                                </div>
                                <div class="grid grid-cols-2">
                                    <div>
                                    ...
                                    <div>
                                        <p v-if="inspeksi.computer.date_of_inventory">
                                            :
                                            {{
                                                formattedDate(
                                                    inspeksi.computer.date_of_inventory
                                                )
                                            }}
                                        </p>
                                        <p v-else>
                                ...
                                <div class="grid grid-cols-2">
                                    ...
                                    <div>
                                        <p v-if="inspeksi.computer.date_of_deploy">
                                            :
                                            {{
                                                formattedDate(
                                ...
                                <div class="grid grid-cols-2">
                                    ...
                                    <div>
                                        <p>: {{ inspeksi.computer.location }}</p>
                                    </div>
                                </div>
                                <div class="grid grid-cols-2">
                                    <div>
                                ...
                                <div class="grid grid-cols-2">
                                    ...
                                    <div>
                                        <p>: {{ inspeksi.computer.condition }}</p>
                                    </div>
                                </div>
                                <div class="grid grid-cols-2">
                                    <div>
                                ...
                                <div class="grid grid-cols-2">
                                    ...
                                    <div>
                                        <p v-if="inspeksi.computer.link_documentation_asset_image != null">

                                            <img :src="inspeksi.computer.link_documentation_asset_image
                                ...
                                <div class="grid grid-cols-2">
                                    ...
                                    <div>
                                        <p>
                                            :
                                            {{
                                                formattedDate(inspeksi.computer.updated_at)
                                            }}
                                        </p>
                                    </div>
                                </div>
