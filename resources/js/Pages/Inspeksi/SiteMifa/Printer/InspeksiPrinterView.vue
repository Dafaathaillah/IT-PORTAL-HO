...
const editData = (id) => {
    form.get(route("inspeksiPrinterMifa.edit", { id: id }));
...
const detailData = (id) => {
    form.get(route("inspeksiPrinterMifa.detail", { id: id }));
};

const processData = (id) => {
    form.get(route("inspeksiPrinterMifa.process", { id: id }));
};
