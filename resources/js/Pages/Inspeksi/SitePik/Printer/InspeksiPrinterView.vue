...
const editData = (id) => {
    form.get(route("inspeksiPrinterPik.edit", { id: id }));
...
const detailData = (id) => {
    form.get(route("inspeksiPrinterPik.detail", { id: id }));
};

const processData = (id) => {
    form.get(route("inspeksiPrinterPik.process", { id: id }));
};
