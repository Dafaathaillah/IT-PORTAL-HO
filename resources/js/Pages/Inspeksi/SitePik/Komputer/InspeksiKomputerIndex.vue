...
const editData = (id) => {
    form.get(route("inspeksiKomputerPik.inspection", { id: id }));
};
...
const editDataInspeksi = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            form.get(route("inspeksiKomputerPik.edit", { id: id }));
        }
    });
};

const detailData = (id) => {
    form.get(route("inspeksiKomputerPik.detail", { id: id }));
};
                                                ...
                                                <tbody>
                                                    ...
                                                    <td
                                                        ...
                                                        >
                                                            ...
                                                            >
                                                                {{
                                                                    computers?.computer?.computer_code || 'Tidak ada no inventory'
                                                                }}
                                                            </p>
                                                        </td>
                                                        ...
                                                        >
                                                            ...
                                                            >
                                                                {{
                                                                    computers?.computer?.pengguna.username || 'Tidak ada pengguna'
                                                                }}
                                                            </p>
                                                        </td>
                                                        <td
                                                        ...
                                                        >
                                                            ...
                                                            >
                                                                ...
                                                                {{
                                                                    computers?.computer?.pengguna.department || 'Tidak ada Department'
                                                                }}
