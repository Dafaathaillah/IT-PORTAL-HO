...
const sendRekapInspeksi = async () => {
    ...
    if (!selectedValues.value || !selectedValues.value.name) {
        Swal.fire(
            "Wajib Memilih PIC",
            "Silakan pilih PIC terlebih dahulu sebelum mengekspor data.",
            "warning"
        );
        return;
    }
    ...
    try {
        const { data } = await axios.post(route("pdf.printer"), {
            year: selectedYear,
...
const editData = (id) => {
    form.get(route("inspeksiPrinterMip.edit", { id: id }));
...
const detailData = (id) => {
    form.get(route("inspeksiPrinterMip.detail", { id: id }));
};

const processData = (id) => {
    form.get(route("inspeksiPrinterMip.process", { id: id }));
};
            ...
            axios
                ...
                .then((response) => {
                    Swal.fire({
                        ...
                        showConfirmButton: false,
                        willClose: () => {
                            router.reload({ only: ["inspeksiPrinterx"] });
                        },
                    });
                })
                .catch((error) => {
                                            ...
                                            <tbody>
                                                ...
                                                >
                                                        ...
                                                        <NavLinkCustom
                                                            ...
                                                            v-if="
                                                                inspeksiPrinters.inspection_status ===
                                                                    'N' &&
                                                                inspeksiPrinters.month ===
                                                                    props.bulan_sekarang &&
                                                                inspeksiPrinters.year ===
                                                    ...
                                                    >
                                                        ...
                                                        >
                                                            {{
                                                                inspeksiPrinters.inspection_at ==
                                                                null
                                                                    ? "-"
                                                                    : formattedDate(
                                                                          inspeksiPrinters.inspection_at
                                                    ...
                                                    >
                                                        ...
                                                        >
                                                            {{
                                                                inspeksiPrinters.status_approval
                                                            }}
                                                        </span>
                                                    </td>
