...
const editData = (id) => {
    form.get(route("inspeksiPrinterAmi.edit", { id: id }));
...
const detailData = (id) => {
    form.get(route("inspeksiPrinterAmi.detail", { id: id }));
};

const processData = (id) => {
    form.get(route("inspeksiPrinterAmi.process", { id: id }));
};
