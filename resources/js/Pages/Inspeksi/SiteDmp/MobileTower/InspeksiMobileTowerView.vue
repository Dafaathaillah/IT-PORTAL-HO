...
watch([selectedMonth, year], ([newMonth, newYear]) => {
    if (newMonth && newYear) {
        router.get(
            route("inspeksiMobileTowerDmp.page"),
            {
...
const editData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            form.get(route("inspeksiMobileTowerDmp.edit", { id: id }));
        }
    });
};
...
const detailData = (id) => {
    form.get(route("inspeksiMobileTowerDmp.detail", { id: id }));
};

const processData = (id) => {
    form.get(route("inspeksiMobileTowerDmp.process", { id: id }));
};
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            axios
                .post(
                    route(
                        "inspeksiMobileTowerDmp.approval",
                        {
