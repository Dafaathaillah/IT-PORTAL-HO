...
const editData = (id) => {
    form.get(route("inspeksiPrinterDmp.edit", { id: id }));
...
const detailData = (id) => {
    form.get(route("inspeksiPrinterDmp.detail", { id: id }));
};

const processData = (id) => {
    form.get(route("inspeksiPrinterDmp.process", { id: id }));
};
