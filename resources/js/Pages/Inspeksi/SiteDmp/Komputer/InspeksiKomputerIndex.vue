...
const editData = (id) => {
    form.get(route("inspeksiKomputerDmp.inspection", { id: id }));
};
...
const editDataInspeksi = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            form.get(route("inspeksiKomputerDmp.edit", { id: id }));
        }
    });
};
...
watch([triwulan, year], ([newQuarter, newYear]) => {
    if (newQuarter && newYear) {
        router.get(
            route("inspeksiKomputerDmp.page"),
            {
                quarter: newQuarter,
                year: newYear,
            },
...
const detailData = (id) => {
    form.get(route("inspeksiKomputerDmp.detail", { id: id }));
};
...
const approved = () => {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            axios
                .post(route('inspeksiKomputerDmp.approval', {}, Ziggy), {
                    headers: {
