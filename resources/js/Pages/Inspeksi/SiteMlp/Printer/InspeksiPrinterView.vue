...
const editData = (id) => {
    form.get(route("inspeksiPrinterMlp.edit", { id: id }));
...
const detailData = (id) => {
    form.get(route("inspeksiPrinterMlp.detail", { id: id }));
};

const processData = (id) => {
    form.get(route("inspeksiPrinterMlp.process", { id: id }));
};
