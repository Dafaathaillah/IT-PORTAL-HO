...
const editData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            form.get(route("inspeksiMobileTowerMlp.edit", { id: id }));
        }
    });
};
...
const detailData = (id) => {
    form.get(route("inspeksiMobileTowerMlp.detail", { id: id }));
};

const processData = (id) => {
    form.get(route("inspeksiMobileTowerMlp.process", { id: id }));
};
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            axios
                .post(
                    route(
                        "inspeksiMobileTowerMlp.approval",
                        {
