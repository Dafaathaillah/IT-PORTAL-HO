...
const editData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            form.get(route("inspeksiLaptopBib.edit", { id: id }));
        }
    });
};
...
const detailData = (id) => {
    form.get(route("inspeksiLaptopBib.detail", { id: id }));
};

const processData = (id) => {
    form.get(route("inspeksiLaptopBib.process", { id: id }));
};
...
const approved = () => {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            axios
                .post(route("inspeksiLaptopBib.approval", {}, Ziggy), {
                    headers: {
