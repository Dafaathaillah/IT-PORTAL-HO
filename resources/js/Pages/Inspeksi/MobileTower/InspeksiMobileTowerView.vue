...
const editData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            form.get(route("inspeksiMobileTower.edit", { id: id }));
        }
    });
};
...
const detailData = (id) => {
    form.get(route("inspeksiMobileTower.detail", { id: id }));
};

const processData = (id) => {
    form.get(route("inspeksiMobileTower.process", { id: id }));
};
