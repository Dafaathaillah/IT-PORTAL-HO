...
const searchData = async () => {
    ...
    try {
        ...
        const routeName = `chart.inspeksiShow`;
...
watch(
    ...
    (chartData) => {
        ...
        Highcharts.chart(chartLaptop.value, {
            ...
            title: {
                text: "Historical Laptop Achievement 2025",
            },
        ...
        Highcharts.chart(chartKomputer.value, {
            ...
            title: {
                text: "Historical Komputer Achievement 2025",
            },
        ...
        Highcharts.chart(chartPrinter.value, {
            ...
            title: {
                text: "Historical Printer Achievement 2025",
            },
        ...
        Highcharts.chart(chartMobileTower.value, {
            ...
            title: {
                text: "Historical MT Achievement 2025",
            },
