...
const form = useForm({
    ...
    software_defrag: props.dataInspeksi.software_defrag,
    software_check_system_restore: props.dataInspeksi.software_check_system_restore,
    software_clean_cache_data: props.dataInspeksi.software_clean_cache_data,
    software_check_ilegal_software: props.dataInspeksi.software_check_ilegal_software,
    software_change_password: props.dataInspeksi.software_change_password,
    software_windows_license: props.dataInspeksi.software_windows_license,
    software_office_license: props.dataInspeksi.software_office_license,
    software_standaritation_software: props.dataInspeksi.software_standaritation_software,
    software_update_sinology: props.dataInspeksi.software_update_sinology,
    software_turn_off_windows_update: props.dataInspeksi.software_turn_off_windows_update,
    software_cheking_ssd_health: props.dataInspeksi.software_cheking_ssd_health,
    software_standaritation_device_name: props.dataInspeksi.software_standaritation_device_name,
    hardware_fan_cleaning: props.dataInspeksi.hardware_fan_cleaning,
    hardware_change_pasta: props.dataInspeksi.hardware_change_pasta,
    hardware_any_maintenance: props.dataInspeksi.hardware_any_maintenance,
    ssd_persen: props.dataInspeksi.software_percentage_ssd_health,
    condition: props.dataInspeksi.condition,
    status_inv: props.dataInspeksi.inventory_status,
    hardware_any_maintenance_explain: props.dataInspeksi.hardware_any_maintenance_explain,
...
const selectedValuesPIC = ref(
    props.pengguna.filter((option) => props.pengguna_selected.includes(option.name))
);
...
const update = () => {
    ...
    form.post(route("inspeksiLaptop.update"), {
        onSuccess: () => {
                        ...
                        <div class="flex-auto p-6">
                            <form @submit.prevent="update">
                                ...
                                <div class="flex flex-wrap -mx-3">
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <div class="inline-flex items-center space-x-4">
                                                <label class="inline-flex items-center space-x-2">
                                                    <input required type="radio" name="defrag" v-model="form.software_defrag"
                                                        value="Y"
                                            ...
                                            <div class="inline-flex items-center space-x-4">
                                                <label class="inline-flex items-center space-x-2">
                                                    <input required type="radio" name="restore"
                                                        v-model="form.software_check_system_restore" value="Y"
                                                        class="form-radio text-blue-600 border-gray-300 focus:ring-blue-500" />
                                                    <span class="text-gray-700">Ya</span>
                                                </label>
                                                ...
                                                <label class="inline-flex items-center space-x-2">
                                                    <input required type="radio" name="restore"
                                                        v-model="form.software_check_system_restore" value="N"
                                                        class="form-radio text-blue-600 border-gray-300 focus:ring-blue-500" />
                                                    <span class="text-gray-700">Tidak</span>
                                                </label>
                                            </div>
                                    ...
                                    <div class="w-full max-w-full px-3 shrink-0 md:w-4/12 md:flex-0">
                                        <div class="mb-4">
                                            ...
                                            <div class="inline-flex items-center space-x-4">
                                                <label class="inline-flex items-center space-x-2">
                                                    <input required type="radio" name="cache" v-model="form.software_clean_cache_data"
                                                        value="Y"
                                                        class="form-radio text-blue-600 border-gray-300 focus:ring-blue-500" />
                                                    <span class="text-gray-700">Ya</span>
                                                </label>
                                            ...
                                            <div class="inline-flex items-center space-x-4">
                                                <label class="inline-flex items-center space-x-2">
                                                    <input required type="radio" name="password"
                                                        v-model="form.software_change_password" value="Y"
                                                        class="form-radio text-blue-600 border-gray-300 focus:ring-blue-500" />
                                                    <span class="text-gray-700">Ya</span>
                                                </label>
                                                ...
                                                <label class="inline-flex items-center space-x-2">
                                                    <input required type="radio" name="password"
                                                        v-model="form.software_change_password" value="N"
                                                        class="form-radio text-blue-600 border-gray-300 focus:ring-blue-500" />
                                                    <span class="text-gray-700">Tidak</span>
                                                </label>
                                            </div>
                                            ...
                                            <div class="inline-flex items-center space-x-4">
                                                <label class="inline-flex items-center space-x-2">
                                                    <input required type="radio" name="lisensi"
                                                        v-model="form.software_windows_license" value="Y"
                                                        class="form-radio text-blue-600 border-gray-300 focus:ring-blue-500" />
                                                    <span class="text-gray-700">Ya</span>
                                                </label>
                                                ...
                                                <label class="inline-flex items-center space-x-2">
                                                    <input required type="radio" name="lisensi"
                                                        v-model="form.software_windows_license" value="N"
                                                        class="form-radio text-blue-600 border-gray-300 focus:ring-blue-500" />
                                                    <span class="text-gray-700">Tidak</span>
                                                </label>
                                            </div>
                                    ...
                                    <div class="w-full max-w-full px-3 shrink-0 md:w-4/12 md:flex-0">
                                        <div class="mb-4">
                                            ...
                                            <div class="inline-flex items-center space-x-4">
                                                <label class="inline-flex items-center space-x-2">
                                                    <input required type="radio" name="office" v-model="form.software_office_license"
                                                        value="Y"
                                                        class="form-radio text-blue-600 border-gray-300 focus:ring-blue-500" />
                                                    <span class="text-gray-700">Ya</span>
                                                </label>
                                            ...
                                            <div class="inline-flex items-center space-x-4">
                                                <label class="inline-flex items-center space-x-2">
                                                    <input required type="radio" name="standarisasi"
                                                        v-model="form.software_standaritation_software" value="Y"
                                                        class="form-radio text-blue-600 border-gray-300 focus:ring-blue-500" />
                                                    <span class="text-gray-700">Ya</span>
                                                </label>
                                                ...
                                                <label class="inline-flex items-center space-x-2">
                                                    <input required type="radio" name="standarisasi"
                                                        v-model="form.software_standaritation_software" value="N"
                                                        class="form-radio text-blue-600 border-gray-300 focus:ring-blue-500" />
                                                    <span class="text-gray-700">Tidak</span>
                                                </label>
                                            </div>
                                    ...
                                    <div class="w-full max-w-full px-3 shrink-0 md:w-4/12 md:flex-0">
                                        <div class="mb-4">
                                            ...
                                            <div class="inline-flex items-center space-x-4">
                                                <label class="inline-flex items-center space-x-2">
                                                    <input required type="radio" name="health" v-model="form.software_cheking_ssd_health"
                                                        value="Y"
                                                        class="form-radio text-blue-600 border-gray-300 focus:ring-blue-500" />
                                                    <span class="text-gray-700">Ya</span>
                                                </label>
                                    ...
                                    <div class="w-full max-w-full px-3 shrink-0 md:w-4/12 md:flex-0">
                                        <div class="mb-4">
                                            ...
                                            <div class="inline-flex items-center space-x-4">
                                                <label class="inline-flex items-center space-x-2">
                                                    <input required type="radio" name="nama" v-model="form.software_standaritation_device_name"
                                                        value="Y"
                                                        class="form-radio text-blue-600 border-gray-300 focus:ring-blue-500" />
                                                    <span class="text-gray-700">Ya</span>
                                                </label>
                                    ...
                                    <div class="w-full max-w-full px-3 shrink-0 md:w-4/12 md:flex-0">
                                        <div class="mb-4">
                                            ...
                                            <div class="inline-flex items-center space-x-4">
                                                <label class="inline-flex items-center space-x-2">
                                                    <input required type="radio" name="fan" v-model="form.hardware_fan_cleaning"
                                                        value="Y"
                                                        class="form-radio text-blue-600 border-gray-300 focus:ring-blue-500" />
                                                    <span class="text-gray-700">Ya</span>
                                                </label>
                                    ...
                                    <div class="w-full max-w-full px-3 shrink-0 md:w-4/12 md:flex-0">
                                        <div class="mb-4">
                                            ...
                                            <div class="inline-flex items-center space-x-4">
                                                <label class="inline-flex items-center space-x-2">
                                                    <input required type="radio" name="pasta" v-model="form.hardware_change_pasta"
                                                        value="Y"
                                                        class="form-radio text-blue-600 border-gray-300 focus:ring-blue-500" />
                                                    <span class="text-gray-700">Ya</span>
                                                </label>
                                            ...
                                            <div class="inline-flex items-center space-x-4">
                                                <label class="inline-flex items-center space-x-2">
                                                    <input required type="radio" name="lainnya"
                                                        v-model="form.hardware_any_maintenance" value="Y"
                                                        class="form-radio text-blue-600 border-gray-300 focus:ring-blue-500" />
                                                    <span class="text-gray-700">Ya</span>
                                                </label>
                                                ...
                                                <label class="inline-flex items-center space-x-2">
                                                    <input required type="radio" name="lainnya"
                                                        v-model="form.hardware_any_maintenance" value="N"
                                                        class="form-radio text-blue-600 border-gray-300 focus:ring-blue-500" />
                                                    <span class="text-gray-700">Tidak</span>
                                                </label>
                                            </div>
                                ...
                                <div class="flex flex-nowrap mt-6 justify-between">
                                    ...
                                    <Link :href="route('inspeksiLaptop.page')"
