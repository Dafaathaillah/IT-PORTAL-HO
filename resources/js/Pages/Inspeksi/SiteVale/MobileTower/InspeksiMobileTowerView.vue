...
watch([selectedMonth, year], ([newMonth, newYear]) => {
    if (newMonth && newYear) {
        router.get(
            route("inspeksiMobileTowerVale.page"),
            {
...
const editData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            form.get(route("inspeksiMobileTowerVale.edit", { id: id }));
        }
    });
};
...
const detailData = (id) => {
    form.get(route("inspeksiMobileTowerVale.detail", { id: id }));
};

const processData = (id) => {
    form.get(route("inspeksiMobileTowerVale.process", { id: id }));
};
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            axios
                .post(
                    route(
                        "inspeksiMobileTowerVale.approval",
                        {
