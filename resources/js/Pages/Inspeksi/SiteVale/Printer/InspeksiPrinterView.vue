...
const editData = (id) => {
    form.get(route("inspeksiPrinterVale.edit", { id: id }));
...
const detailData = (id) => {
    form.get(route("inspeksiPrinterVale.detail", { id: id }));
};

const processData = (id) => {
    form.get(route("inspeksiPrinterVale.process", { id: id }));
};
