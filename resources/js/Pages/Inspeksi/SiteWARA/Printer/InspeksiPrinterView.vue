...
const editData = (id) => {
    form.get(route("inspeksiPrinterAdw.edit", { id: id }));
...
const detailData = (id) => {
    form.get(route("inspeksiPrinterAdw.detail", { id: id }));
};

const processData = (id) => {
    form.get(route("inspeksiPrinterAdw.process", { id: id }));
};
