...
const editData = (id) => {
    form.get(route("inspeksiPrinterBa.edit", { id: id }));
...
const detailData = (id) => {
    form.get(route("inspeksiPrinterBa.detail", { id: id }));
};

const processData = (id) => {
    form.get(route("inspeksiPrinterBa.process", { id: id }));
};
