...
const getEncryptedYear = () => {
    ...
    router.post(
        route("encrypt.year"),
        { year: selectedYear, site: "BA", pic: selectPic },
        {
            onSuccess: ({ props }) => {
...
const editData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            form.get(route("inspeksiLaptopBa.edit", { id: id }));
        }
    });
};
...
const detailData = (id) => {
    form.get(route("inspeksiLaptopBa.detail", { id: id }));
};

const processData = (id) => {
    form.get(route("inspeksiLaptopBa.process", { id: id }));
};
...
const approved = () => {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            axios
                .post(route("inspeksiLaptopBa.approval", {}, Ziggy), {
                    headers: {
