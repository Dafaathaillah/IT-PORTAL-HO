...
const editData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            form.get(route("inspeksiMobileTowerMhu.edit", { id: id }));
        }
    });
};
...
const detailData = (id) => {
    form.get(route("inspeksiMobileTowerMhu.detail", { id: id }));
};

const processData = (id) => {
    form.get(route("inspeksiMobileTowerMhu.process", { id: id }));
};
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            axios
                .post(
                    route(
                        "inspeksiMobileTowerMhu.approval",
                        {
