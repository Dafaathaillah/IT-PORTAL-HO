...
const editData = (id) => {
    form.get(route("inspeksiPrinterMhu.edit", { id: id }));
...
const detailData = (id) => {
    form.get(route("inspeksiPrinterMhu.detail", { id: id }));
};

const processData = (id) => {
    form.get(route("inspeksiPrinterMhu.process", { id: id }));
};
