...
const getEncryptedYear = () => {
    ...
    router.post(
        route("encrypt.year"),
        { year: selectedYear, site: "MHU", pic: selectPic },
        {
            onSuccess: ({ props }) => {
...
const editData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            form.get(route("inspeksiLaptopMhu.edit", { id: id }));
        }
    });
};
...
const detailData = (id) => {
    form.get(route("inspeksiLaptopMhu.detail", { id: id }));
};

const processData = (id) => {
    form.get(route("inspeksiLaptopMhu.process", { id: id }));
};
...
const approved = () => {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            axios
                .post(route("inspeksiLaptopMhu.approval", {}, Ziggy), {
                    headers: {
