...
const editData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            form.get(route("inspeksiMobileTowerSbs.edit", { id: id }));
        }
    });
};
...
const detailData = (id) => {
    form.get(route("inspeksiMobileTowerSbs.detail", { id: id }));
};

const processData = (id) => {
    form.get(route("inspeksiMobileTowerSbs.process", { id: id }));
};
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            axios
                .post(
                    route(
                        "inspeksiMobileTowerSbs.approval",
                        {
