...
const editData = (id) => {
    form.get(route("inspeksiPrinterSbs.edit", { id: id }));
...
const detailData = (id) => {
    form.get(route("inspeksiPrinterSbs.detail", { id: id }));
};

const processData = (id) => {
    form.get(route("inspeksiPrinterSbs.process", { id: id }));
};
