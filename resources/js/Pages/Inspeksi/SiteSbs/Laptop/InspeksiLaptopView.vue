...
const getEncryptedYear = () => {
    ...
    router.post(
        route("encrypt.year"),
        { year: selectedYear, site: "SBS", pic: selectPic },
        {
            onSuccess: ({ props }) => {
...
const editData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            form.get(route("inspeksiLaptopSbs.edit", { id: id }));
        }
    });
};
...
const detailData = (id) => {
    form.get(route("inspeksiLaptopSbs.detail", { id: id }));
};

const processData = (id) => {
    form.get(route("inspeksiLaptopSbs.process", { id: id }));
};
...
const approved = () => {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            axios
                .post(route("inspeksiLaptopSbs.approval", {}, Ziggy), {
                    headers: {
