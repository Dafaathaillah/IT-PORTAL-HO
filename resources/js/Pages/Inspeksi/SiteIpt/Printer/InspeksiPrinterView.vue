...
const editData = (id) => {
    form.get(route("inspeksiPrinterIpt.edit", { id: id }));
...
const detailData = (id) => {
    form.get(route("inspeksiPrinterIpt.detail", { id: id }));
};

const processData = (id) => {
    form.get(route("inspeksiPrinterIpt.process", { id: id }));
};
