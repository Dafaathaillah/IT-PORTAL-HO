...
const form = useForm({
    ...
    nrp: props.pengguna.nrp,
    username: props.pengguna.name,
    department: props.pengguna.department,
    position: props.pengguna.position,
...
const save = () => {
    ...
    form.post(route("managementUserIct.update"), {
        onSuccess: () => {
                                ...
                                <div class="flex flex-wrap -mx-3">
                                    ...
                                    <div class="w-full max-w-full px-3 shrink-0 md:w-6/12 md:flex-0">
                                        <div class="mb-4">
                                            ...
                                            <select id="role" required v-model="form.role" name="role"
