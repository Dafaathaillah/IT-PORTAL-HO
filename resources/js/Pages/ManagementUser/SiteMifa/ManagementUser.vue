...
const deleteData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            form.delete(route("penggunaMifa.delete", { id: id }), {
                onSuccess: () => {
                    Swal.fire({
                        title: "Deleted!",
...
const editData = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            form.get(route("penggunaMifa.edit", { id: id }));
        }
    });
};
...
const submitCsv = () => {
    ...
    formx.post(route("penggunaMifa.import"), {
        onSuccess: () => {
            Swal.fire({
                title: "Success!",
                ...
                <div class="flex flex-wrap -mx-3">
                    ...
                    >
                        <div class="flex">
                            ...
                            >
                                <a
                                    href="/sampleUserPengguna.xlsx"
                                    download="Format-Import-Data-User-Pengguna.xlsx"
                                    target="_blank"
                                    type="button"
                                    class="text-gray-900 bg-white border border-gray-300 focus:outline-none hover:bg-gray-100 focus:ring-4 focus:ring-gray-100 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-gray-800 dark:text-white dark:border-gray-600 dark:hover:bg-gray-700 dark:hover:border-gray-600 dark:focus:ring-gray-700"
                                >
                    ...
                    <div class="flex-none w-full max-w-full px-3">
                        ...
                        >
                            ...
                            >
                                <Link
                                    :href="route('penggunaMifa.create')"
